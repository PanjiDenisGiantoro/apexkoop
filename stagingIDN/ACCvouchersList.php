...
if ($by == 2)	print '<option value="2" selected>No. Baucer</option>'; 			else print '<option value="2">No. Baucer</option>';	
if ($by == 3)	print '<option value="3" selected>Keterangan</option>'; 			else print '<option value="3">Keterangan</option>';		
if ($by == 4)	print '<option value="4" selected>Bayar Kepada</option>'; 			else print '<option value="4">Bayar Kepada</option>';
			...
			<td valign="top">
				<table border="0" cellspacing="1" cellpadding="2" width="100%" class="table table-sm table-striped">
					<tr class="table-primary">
						<td nowrap style="text-align: center; vertical-align: bottom;"><b>Bil</b></td>
						<td nowrap style="text-align: left; vertical-align: bottom;"><b>No. Baucer</b></td>
						...
						<td nowrap style="text-align: left; vertical-align: bottom;"><b>Bank</b></td>
						<td nowrap style="text-align: left; vertical-align: bottom;"><b>Bayar Kepada</b></td>
						<td nowrap style="text-align: left; vertical-align: bottom;"><b>Catatan</b></td>
						<td nowrap style="text-align: right; vertical-align: bottom;"><b>Jumlah (RM)</b></td>					
