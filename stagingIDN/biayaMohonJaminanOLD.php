 ...
 *          Filename		: 	biayaMohonJaminan.php
 *          Date 		: 	12/12/2018
 *********************************************************************************/
include("header.php");
...
$sFileName		= "biayaMohonJaminan.php";
...
if (dlookup("loans", "statuspID1", "loanID= '" . $pk . "'")) $approve1 = '<img src="images/sym-tick-red-bkrm-01.gif" height="20" width="20">';
else $approve1 = '<img src="images/delete.jpg" height="15" width="15">';

if (dlookup("loans", "statuspID2", "loanID= '" . $pk . "'")) $approve2 = '<img src="images/sym-tick-red-bkrm-01.gif" height="20" width="20">';
else $approve2 = '<img src="images/delete.jpg" height="15" width="15">';

if (dlookup("loans", "statuspID3", "loanID= '" . $pk . "'")) $approve3 = '<img src="images/sym-tick-red-bkrm-01.gif" height="20" width="20">';
else $approve3 = '<img src="images/delete.jpg" height="15" width="15">';
...
for ($i = 1; $i <= count($FormLabel); $i++) {
	...
	if ($i == 1) print '<tr><td class="headerteal" colspan=4>1. Penjamin pertama</td></tr>';
	if ($i == 3) print '<tr><td class="headerteal" colspan=4>2. Penjamin kedua</td></tr>';
	if ($i == 5) print '<tr><td class="headerteal" colspan=4>3. Penjamin ketiga</td></tr>';
	...
	if ($i == 1) {
		if ($status < 3) {
			print '
		<input type="button" class="label" value="..." onclick="window.open(\'selToJaminan.php?refer=d&obj=1\',\'sel\',\'top=10,left=10,width=750,height=500,scrollbars=yes,resizable=yes,toolbars=no,location=no,menubar=no\');">
		&nbsp;';
			print '<input type="button" value="Batal" onclick="document.MyForm.penjaminID1.value=\'\';document.MyForm.sellUserName1.value=\'\';">&nbsp;';
		}
	}
	...
	if ($i == 3) {
		if ($status < 3) {
			print '
		<input type="button" class="label" value="..." onclick="window.open(\'selToJaminan.php?refer=d&obj=2\',\'sel\',\'top=10,left=10,width=850,height=500,scrollbars=yes,resizable=yes,toolbars=no,location=no,menubar=no\');">
		&nbsp;';
			print '<input type="button" value="Batal" onclick="document.MyForm.penjaminID2.value=\'\';document.MyForm.sellUserName2.value=\'\';">&nbsp;';
		}
	}
	...
	if ($i == 5) {
		if ($status < 3) {
			print '
		<input type="button" class="label" value="..." onclick="window.open(\'selToJaminan.php?refer=d&obj=3\',\'sel\',\'top=10,left=10,width=850,height=500,scrollbars=yes,resizable=yes,toolbars=no,location=no,menubar=no\');">
		&nbsp;';
			print '<input type="button" value="Batal" onclick="document.MyForm.penjaminID3.value=\'\';document.MyForm.sellUserName3.value=\'\';">&nbsp;';
		}
	}
	print '&nbsp;</td>';
	if ($cnt == 0) print '</tr>';
