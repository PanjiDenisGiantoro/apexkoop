...
$title     = "Senarai Permohonan Bantuan Kebajikan";
...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <input type="button" class="btn btn-md btn-primary" value="+ Mohon Baru" onClick="window.location.href=\'?vw=welfareApply&mn=921\'"/>
</div>
