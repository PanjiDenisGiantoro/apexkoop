...
if (get_session("Cookie_groupID") > 0) {
	...
	<tr></tr>';
		...
		<tr valign="top" class="textFont">
			<td>
				<table width="100%">
					<tr style="font-family: Poppins, Helvetica, sans-serif; font-size: 10pt;">
						<td  class="textFont">&nbsp;Jumlah Anggota PGB &nbsp' . $TotalRec . '</td>
						</tr>
				</table>
			</td>
		</tr>';
			...
			while (!$GetMember->EOF) {
				...
				print ' <tr style="font-family: Poppins, Helvetica, sans-serif; font-size: 10pt;" bgcolor="FFFFFF">
						...
						<td class="Data" align="left">' . $GetMember->fields('accTabungan') . '</td>	
