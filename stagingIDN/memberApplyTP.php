...
<form name="MyForm" action=<? print $sFileName; ?> method=post>
	...
	?>&nbsp;<input type="button" class="btn btn-sm btn-info" value="Pilih" onclick="window.open('selMemberT.php','sel','top=10,left=10,width=950,height=500,scrollbars=yes,resizable=yes,toolbars=no,location=no,menubar=no');"><?
																																																							}
																																																						}

																																																						$Gambar = "upload_henti/" . $pic;
...
<?
																																																							if ($pic) {
																																																								print '<input type=button value="PAPARAN DOKUMEN" class="btn btn-outline-danger waves-effect" onClick=window.open(\'upload_henti/' . $pic . '\',"pop","top=50,left=50,width=700,height=450,scrollbars=yes,resizable=yes,toolbars=no,location=no,menubar=no");>
	';
																																																							}
?>
<?
