...
$title     = "Senarai Pembiayaan Dalam Proses";
...
if ($GetLoan->RowCount() <> 0) {
	...
	while (!$GetLoan->EOF && $cnt <= $pg) {
		...
		if ($status == 1) {
			print '<span class="mdi mdi-information-outline" rel="tooltip" title="Pembiayaan anda telah diproses dan sedang disediakan."></span>';
		}
		if ($status == 2) {
