...
$sSQL = "";
$sWhere = " (a.RVNo IN ($subQuery) AND a.invNo IS NULL) OR (a.invNo IS NULL";
...
$sSQL = "SELECT *, b.name, b.g_lockstat 
		FROM cb_payments a 
		JOIN generalacc b ON a.batchNo = b.ID
		";

if ($mm <> "ALL") $sWhere .= " AND month( A.tarikh_RV ) =" . $mm;
$sSQL 		= $sSQL . $sWhere . " order by RVNo desc";
...
// if ($by == 3)	print '<option value="3" selected>Nombor Invois</option>'; 	else print '<option value="3">Nombor Invois</option>';				
...
if ($GetBaucers->RowCount() <> 0) {
			...
			<td valign="top">
				<table border="0" cellspacing="1" cellpadding="2" width="100%" class="table table-sm table-striped">
					<tr class="table-primary">
						...
						<td nowrap align="left"><b>Nombor Bayaran</b></td>
						<td nowrap align="center"><b>Nama Batch</b></td>
						<td nowrap align="center"><b>Tarikh</b></td>
						<td nowrap align="left"><b>Nama Syarikat</b></td>						
						<td nowrap align="left"><b>Nombor Invois</b></td>
	...
	while (!$GetBaucers->EOF && $cnt <= $pg) {
		...
		$RVNo 		= $GetBaucers->fields(RVNo);
		$companyID 	= $GetBaucers->fields(companyID);
