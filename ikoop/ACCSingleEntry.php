...
<tr>
	<td width="48%">
		<table border="0" cellspacing="1" cellpadding="2">
			...
			<tr> <td>Zon</td> <td valign="top"></td> <td>'.selectjabatan($kod_jabatan,'kod_jabatan').'</td> </tr>
	...
	<td width="48%" align="right">
		<table border="0" cellspacing="1" cellpadding="2">
			<tr>
				...
				<td valign="top"></td>
				<td><input class="form-controlx" name="tarikh_entry" value="'.$tarikh_entry.'" type="text" size="20" maxlength="10"/></td>
			</tr>
		</table>
	</td>
</tr>
...
print	   '<tr>
				...
				<td class="Data" nowrap="nowrap">
					<input name="desc_akaun['.$id.']" type="text" size="40" maxlength="100" class="form-control-sm" value="'.$desc_akaun.'"/>
				</td>
...
print	   '<tr>
				...
				<td class="Data" align="left">
					<input name="desc_akaun2" type="text" size="35" maxlength="100" value="'.$desc_akaun2.'" class="form-control-sm" align="right"/>&nbsp;
				</td>			
