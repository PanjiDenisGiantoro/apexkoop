...
*          Filename		: 	ACClaporanPemuitang.php
*          Date 		: 	17/4/2020
*********************************************************************************/
...
$sFileName = "?vw=ACClaporanPemuitang&mn=$mn"; 
$sFileRef  = "?vw=ACClaporanPemuitang&mn=$mn";
$title     = "Senarai Penyata Invoice Pemuitang";
...
$sSQL = "";
$sWhere = " a.ID = b.companyID AND a.category='AC'";
...
if($ID) {
	...
	$sWhere = " WHERE (" . $sWhere . ")";
	$sSQL = "SELECT	DISTINCT a.* FROM generalacc a, cb_invoice b";
