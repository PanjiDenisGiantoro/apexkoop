...
$bulanLewat = $lewatBlnLts + $lewatBlnSum;
...
//$bond = dlookup("loandocs", "rnoBond", "loanID=" . $rsLoan->fields(loanID));
$Sebulan = dlookup("loans", "monthlyPymt", "loanID=" . $rsLoan->fields(loanID));
$UntungPokok = dlookup("loandocs", "lpotBiayaN", "loanID=" . $rsLoan->fields(loanID));
$bulanLewat = dlookup("accounthL", "SumBlnSb", "loanID=" . $rsLoan->fields(loanID));
$LewatCajBulan = $Sebulan * 0.01;
$blnLewat = $LewatCajBulan * $bulanLewat;
...
$bakiAwalUntgCmpr = $bakiAwal + $bakiAwalUnt ; 
...
print '
	...
	<tr bgcolor="#336699" style="font-family: Arial, Helvetica, sans-serif; font-size: 9pt; font-weight: bold;">
		...
		<td colspan="2">
			<table border=1  cellpadding="2" cellspacing="0" align=left width="100%">
				...
				<tr style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt;" bgcolor="FFFFFF">
					...
					<td width="10%" align="right">&nbsp;'.number_format($UntungPokok,2).'</td>
					<td width="10%" align="right">&nbsp;'.number_format($bakiAwalKreditPokok,2).'</td>
				</tr>			
				            <tr style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt;" bgcolor="FFFFFF">
							<td width="5%" align="center">'.++$i.'.</td>
							<td width="12%" align="center">&nbsp;'.$today.'</td>
							<td width="10%">&nbsp;</td>
							<td align="left">&nbsp;CAJ LEWAT '.$bulanLewat.' BULAN X 1%</td>';
							$blnLewat = number_format($blnLewat,2);																		
							 print'</td>
							<td width="10%" align="right">&nbsp;'.$blnLewat .'</td>
				...
				//if ($rs->RowCount() <> 0) {	
					while(!$rs->EOF) {	
						...
						<tr style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt;" bgcolor="FFFFFF">
							<td width="5%" align="center">'.++$i.'.</td>
							<td width="12%" align="center">&nbsp;'.toDate('d/m/y',$rs->fields(createdDate)).'</td>
					...
					$sumDebit = $totaldebit + $UntungPokok + $blnLewat;
					$totalkreditAll = $bakiAwalKreditPokok + $totalkredit;
				...
				print '
					...
					<td width="10%" colspan=3 align="right">&nbsp;</td>
						...
						<td width="10%" align="right">&nbsp;'.number_format($totalkreditAll,2).'</td>
					</tr>';
					
					$bakiHB = $sumDebit;
					$bakiBB = $bakiHB - $totalkreditAll;
					print '
				<tr style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt;" bgcolor="FFFFFF">
					<td width="10%" colspan=3 align="right">&nbsp;</td>
