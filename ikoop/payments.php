...
'<tr>
	<td colspan="3">
		<table border="0" cellspacing="1" cellpadding="2">
			<tr><td>No. Auto Pay</td><td valign="top"></td><td><input class="form-controlx" name="no_bayar" value="'.$no_bayar.'" type="text" size="20" maxlength="50" readonly/></td></tr>
...
print	   '<tr>
				...
				<td class="Data" align="right">
					<input name="amount['.$id.']" type="text" size="10" maxlength="10" value="'.$amount.'" class="form-control-sm" style="text-align:right;"/>&nbsp;
				</td>				
...
<tr>
	...
	<td width="40%" align="right" valign="top">
		<table border="0" cellspacing="1" cellpadding="2">
			...
			<tr><td nowrap="nowrap">No.Siri</td><td valign="top">:</td><td><input name="no_siri" value="'.$no_siri.'" type="text" size="20" maxlength="50" /></td></tr>
	...
	function CheckField(act) {
		...
		for(c=0; c<e.elements.length; c++) {
		  ...
		  if(e.elements[c].name=="userID" && e.elements[c].value==\'\') {
			alert(\'No. anggota tidak dibenar kosong\');
            count++;
		  }
