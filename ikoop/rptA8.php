...
*          Filename		: 	rptA4.php
*		   Description	:	Report Senarai Keseluruhan Koperasi
*          Date 		: 	12/12/2003
*********************************************************************************/
session_start();
...
$title  = 'Senarai Koperasi Ada Emel';
...
$sSQL = "";
$sSQL = "SELECT	a.name, a.loginID, a.email, CAST( b.kopNum AS SIGNED INTEGER ) as kopNum, b.approvedDate, b.jenis, c.name as department
		 FROM 	users a, userdetails b
		 INNER	JOIN general c
		 ON		c.ID = b.departmentID
		 WHERE  a.userID = b.userID
		 AND 	b.status = '1'
		 AND    BIT_LENGTH(a.email) > 0";
if ($dept <> "ALL")
