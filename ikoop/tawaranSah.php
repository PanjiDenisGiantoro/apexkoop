...
function myFunction3() {
	...
	document.getElementById("demo3d").innerHTML = "Mengambil pemilikan aset/komoditi tersebut secara fizikal atau menjual kepada pihak-pihak lain dengan segala kos berkaitan ditanggung oleh saya sendiri. Saya dengan ini melepaskan Koperasi ALM CORE SOLUTIONS SDN BHD daripada segala tanggungan dan mengaku janji untuk menanggungrugi ke semua kos dan perbelanjaan atau kerosakan yang Koperasi mungkin alami atau tanggung berikutan pilihan ini.";
	document.getElementById("demo3e").innerHTML = "<strong>ATAU</strong>";
	document.getElementById("demo3f").innerHTML = "Setuju menjual aset/komoditi tersebut kepada Koperasi ALM CORE SOLUTIONS SDN BHD mengikut syarat-syarat yang ditetapkan di dalam perjanjian belian.";
