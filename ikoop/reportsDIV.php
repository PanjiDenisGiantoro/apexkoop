...
<table border="0" cellspacing="1" cellpadding="3" width="100%" align="center">
	<tr>
		...
		<h6 class="card-subtitle mt-3"><u>LAPORAN PEMBAYARAN DIVIDEN</u></h6>
		<li id="print" class="textFont">&nbsp;&nbsp;<a href="#" onclick="selectUrusniaga('rptBDivTgkk')">Tunggakan Dividen</a>
        		<li id="print" class="textFont">&nbsp;&nbsp;<a href="#" onclick="selectUrusniaga('rptBDivTgkkUP')">Upfront Dividen</a>
        <li id="print" class="textFont">&nbsp;&nbsp;<a href="#" onclick="selectUrusniaga('rptBThn')">Pembayaran Dividen Tahunan(Khidmat)</a>
                <li id="print" class="textFont">&nbsp;&nbsp;<a href="#" onclick="selectUrusniaga('rptBThnBer')">Pembayaran Dividen Tahunan (Bersara)</a>
		<li id="print" class="textFont">&nbsp;&nbsp;<a href="#" onclick="selectUrusniaga('rptJumAllDiv')">Jumlah Keseluruhan Pembayaran Dividen Tahunan Anggota</a>
