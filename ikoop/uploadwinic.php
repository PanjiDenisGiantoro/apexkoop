    ...
    <div class="table-responsive">
        ...
        <table class="table mb-3">
                <tr class="table-primary">
                    <td class=Header><h6 class="card-subtitle">Sila Masukkan IC Anda: '.$no_resit.'</h6></td>
                </tr>
                <tr class="table-light">
                        <td class="Data">
					
                                    <form action="?vw=uploadwinic&mn=3&action=upload" method=post  enctype="multipart/form-data">
