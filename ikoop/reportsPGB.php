...
$sFileName = 'reportsPGB.php';
$sFileRef  = 'reportsPGB.php';
$title     = 'LAPORAN POTONGAN GAJI ANGGOTA';
...
<table border="0" cellspacing="1" cellpadding="3" width="100%" align="center">
	<tr>
		...
		<li id="print" class="textFont">&nbsp;&nbsp;<a href="#" onClick="selectUrusniaga('rptPGBKlik')">Senarai Pembiayaan Yang Belum Diklik</a>
</tr>
 <tr>
<td class="Label" valign="top"> <br /><br />
	<i class="fas fa-hand-point-right"></i>&nbsp;Laporan Baki Pembiayaan
<li id="print" class="textFont">&nbsp;&nbsp;<a href="#" onClick="selectUrusniaga('rptSenaraiBakiAkhirPem')">Baki Pembiayaan Peribadi</a>
<li id="print" class="textFont">&nbsp;&nbsp;<a href="#" onClick="selectUrusniaga('rptSenaraiBakiAkhirPem')">Baki Pembiayaan Barangan</a>
<li id="print" class="textFont">&nbsp;&nbsp;<a href="#" onClick="selectUrusniaga('rptSenaraiBakiAkhirPem')">Baki Pembiayaan Kecemasan</a>
                   
</tr>
<tr>
<td class="Label" valign="top">
<br /><br />
	<i class="fas fa-hand-point-right"></i>&nbsp;Laporan Pecahan Potongan Gaji Bulanan (Berkhidmat)
<li id="print" class="textFont">&nbsp;<a href="#" onClick="selectUrusniaga('laporanpecahanALLtunai')">Pecahan Potongan Bulanan Peribadi</a>
<li id="print" class="textFont">&nbsp;<a href="#" onClick="selectUrusniaga('laporanpecahanALLbarang')">Pecahan Potongan Bulanan Barangan</a>
<li id="print" class="textFont">&nbsp;<a href="#" onClick="selectUrusniaga('laporanpecahanALLcemas')">Pecahan Potongan Bulanan Kecemasan</a>
</td></tr>
</table>
<?		
include("footer.php");	
...
<script>
	...
	function selectPengurusan(rpt) {
		window.open("laporanpecahanSPSN.php" ,"pop","scrollbars=yes,resizable=yes,toolbars=no,location=no,menubar=yes");					
	}
