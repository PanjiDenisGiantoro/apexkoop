...
if(isset($pk)){ //$pk = $loanID; //get loan id
		...
		rnoBaucer, rnoBond, rcreatedDate, rpreparedby, approvedBy, prepare, review, 
		ajk1, ajk2, ajk3, ajkDate1, ajkDate2, ajkStat1, ajkStat2, result, yuranBul, yuranSedia,	
		createDate, createdBy, prepare,	prepareDate, prepareBy, review, reviewDate, reviewBy
		...
		//echo "check value $a1- $b1- $c1- $b2 -$b2 - $b2 -$c1- $c2- $c3";
			...
			$ctlajkStat1 = 'disabled';
			$ctlajkStat2 = 'disabled';
			$rem = "Status: Dokumen sudah diproses sedia dan perlu disemak.";
			$remStat = 0;
			...
			$ctlajkStat1 = '';
			$ctlajkStat2 = 'disabled';
			$rem = "Status: Dokumen memerlukan kelulusan ajk 1";
			$remStat = 1;
			}elseif($prepare && $review && $ajkStat1 && !$ajkStat2){
			$ctlprepare = 'disabled';
			$ctlreview = 'disabled';
			$ctlajkStat1 = 'disabled';
			$ctlajkStat2 = '';
			$rem = "Status: Dokumen memerlukan kelulusan ajk 2";
			$remStat = 1;
			}elseif($prepare && $review && $ajkStat1 && $ajkStat2){
			$ctlprepare = 'disabled';
			$ctlreview = 'disabled';
			...
			$ctlDisediakanB = '';
			$ctlDisahkanB  = '';
			$rem = "Status: Dokumen diluluskan dan sedia untuk pengeluaran baucer.";
			$remStat = 1;
			}
			if($rs->fields(result)=="tolak" && $ajkStat2) $rem = "Status: Dokumen permohonan pembiayaan ditolak";
			//}	
		}
}
		...
		if ($rs->RowCount() <> 0){
			while (!$rs->EOF) {
				...
				if($pid= dlookup("loans", "penjaminID1", "loanID='".$loID."'")){ //compare get gurrentee id
					if($pid==$memberIDy) $field = 1; $bList[$j] = $loID; $biayaTotal[$j] = $loAmt;
				}
				if($pid= dlookup("loans", "penjaminID2", "loanID='".$loID."'")){
					if($pid==$memberIDy) $field= 2; $bList[$j] = $loID; $biayaTotal[$j] = $loAmt;
				}
				if($pid= dlookup("loans", "penjaminID3", "loanID='".$loID."'")){
					if($pid==$memberIDy)	$field = 3; $bList[$j] = $loID; $biayaTotal[$j] = $loAmt;
				}	
				$j++;
				$rs->MoveNext();
			}
...
//************************
	// MODUL PEMBIAYAAN 
		$memberID       = $userID;
		$memberNo		= $userID;
		$memberName		= '<a href="?vw=biaya&mn=906&pk='.$pk.'">'.dlookup("users", "name", "userID=" . $userID).'</a>';
		...
		// BORANG SEMAKAN KOMITI PEMBIAYAAN

$strHeaderTitle = '&nbsp;</b><a class="maroon" href="?vw=loan">SENARAI</a><b>&nbsp;>&nbsp;DOKUMEN PROSES PEMBIAYAAN</b>';
...
<ul class="nav nav-tabs" id="myTab" role="tablist">
    <li class="nav-item" role="presentation">
        <a href="<?php echo $sFileName;?>&tabb=1" class="nav-link <?php if(@$tabb==1){ echo "active"; }?>" id="home-tab"   aria-controls="home" aria-selected="true">DOKUMEN PROSES</a>
    </li>
    <li class="nav-item" role="presentation">
        <a href="<?php echo $sFileName;?>&tabb=2" class="nav-link <?php if(@$tabb==2){ echo "active"; }?>" id="profile-tab"  aria-controls="profile" aria-selected="false">KELULUSAN JAWATANKUASA</a>
    </li>                                             
</ul>
<br>               
...
<div class="tab-content p-3" id="myTabContent">
    <div class="tab-pane fade <?php if(@$tabb==1){ echo "active show"; }?>" id="home" role="tabpanel" aria-labelledby="home-tab">
        <p class="mb-0">
            <?php
            print '<div class="card-header mt-2"><b>Borang Dokumen Proses Pembiayaan</b></div><BR><BR>';
            include "biayaDokumenMain.php";
            print '<br><br>';
            ?>
        </p>
    </div>
    <div class="tab-pane fade <?php if(@$tabb==2){ echo "active show"; }?>" id="profile" role="tabpanel" aria-labelledby="profile-tab">
        <p class="mb-0">
            <?php
	...
	print  '<tr><td>&nbsp;</td></tr>
			<tr><td>&nbsp;</td></tr>
			<tr><td class="padding1" colspan="2" style="border-top:#000000 solid 1px;border-bottom:#000000 solid 1px;"><b>Maklumat pembiayaan lama</b></td></tr>
			<tr>
				<td colspan="2">
					<table cellpadding="0" cellspacing="0" width="100%">
						<tr>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td width="100" align="center" valign="top" style="border-left:#000000 solid 1px;">No. Bond</td>
							<td width="100" align="center" valign="top" style="border-left:#000000 solid 1px;">Tarikh Dikeluarkan</td>
							<td width="100" align="center" valign="top" style="border-left:#000000 solid 1px;">Jumlah Lulus</td>
							<td width="100" align="center" valign="top" style="border-left:#000000 solid 1px;">Tempoh Lulus(Bulan)</td>
							<td width="100" align="center" valign="top" style="border-left:#000000 solid 1px;">Bayaran Bulanan</td>
							<td width="100" align="center" valign="top" style="border-left:#000000 solid 1px;">Baki Terkini</td>
							<td style="border-left:#000000 solid 1px;">&nbsp;</td>
						</tr>';
			if ($Get->RowCount() <> 0) {  
				while (!$Get->EOF) {
					$loanTypeCode	= dlookup("general", "code", "ID=" . tosql($Get->fields(loanType), "Number"));
					$loanTypeCodeID	= dlookup("general", "c_Deduct", "ID=" . tosql($loanTypeID, "Number"));
					$loanType		= dlookup("general", "name", "ID=" . tosql($loanTypeCodeID, "Text"));

					 print '<tr>  
							<td>&nbsp;'.$loanType.'</td>
							<td style="border-top:#000000 solid 1px;border-left:#000000 solid 1px;" align="right">&nbsp;'.$Get->fields(loanNo).'</td>
							<td style="border-top:#000000 solid 1px;border-left:#000000 solid 1px;" align="right">&nbsp;'.todate("d/m/y",$Get->fields(approvedDate)).'</td>
							<td style="border-top:#000000 solid 1px;border-left:#000000 solid 1px;" align="right">&nbsp;'.$Get->fields(loanAmt).'</td>
							<td style="border-top:#000000 solid 1px;border-left:#000000 solid 1px;" align="right">&nbsp;'.$Get->fields(loanPeriod).'</td>
							<td style="border-top:#000000 solid 1px;border-left:#000000 solid 1px;" align="right">&nbsp;'.($Get->fields(pokok)+$Get->fields(untung)).'</td>
							<td style="border-top:#000000 solid 1px;border-left:#000000 solid 1px;" align="right">&nbsp;'.$Get->fields(outstandingAmt).'</td>
							<td style="border-left:#000000 solid 1px;">&nbsp;</td>
						</tr>';
			    $Get->MoveNext();
				}
				...
				print	'<tr>
							<td>&nbsp;</td>
							<td style="border-top:#000000 solid 1px;border-left:#000000 solid 1px;" align="right">&nbsp;</td>
							<td style="border-top:#000000 solid 1px;border-left:#000000 solid 1px;" align="right">&nbsp;</td>
							<td style="border-top:#000000 solid 1px;border-left:#000000 solid 1px;" align="right">&nbsp;</td>
							<td style="border-top:#000000 solid 1px;border-left:#000000 solid 1px;" align="right">&nbsp;</td>
							<td style="border-top:#000000 solid 1px;border-left:#000000 solid 1px;" align="right">&nbsp;</td>
			...
			<tr><td class="padding1" colspan="2" style="border-top:#000000 solid 1px;border-bottom:#000000 solid 1px;">&nbsp;</td></tr>
			...
			<tr>
				<td align ="center" valign="top" width="50%" colspan="2"><u><b><input class="form-check-input" type="checkbox" name="lulus" '.$lulusb.'> DILULUSKAN / <input class="form-check-input" type="checkbox" name="tolak" '.$tolakb.'> DITOLAK</b></u>
				</td>
			</tr>
			<tr>
				<td align ="center" valign="top" width="50%" colspan="2">RM : '.number_format($amtLoan,2).'
				</td>
			</tr>
			<tr>
				<td align ="center" valign="top" width="50%" colspan="2">TEMPOH : '.$loanPeriod.' Bulan
				</td>
			</tr>
			<tr>
				<td align ="center" valign="top" width="50%" colspan="2"><br><u><b>SYARAT-SYARAT TAMBAHAN</b></u><br>
				</td>
			</tr>';
...
print '		<tr>
				<td colspan="2">
					<table cellpadding="0" cellspacing="0" width="100%">
						<tr>
							<td colspan="3">Bagi pembiayaan bertindih sahaja :-</td>
						</tr>
						<tr>
							<td colspan="3">1. Tolak Keuntungan sebulan</td>
						</tr>
						<tr>
							<td colspan="3">2. Caj Perkhidmatan Dikenakan</td>
						</tr>
						<tr>
							<td colspan="3">3.</td>
						</tr>
						...
						<tr>
							<td width="34%">Ajk 1: '.$ajk1.'</td>
							<td width="33%">Ajk 2: '.$ajk2.'</td>
							<td width="33%">&nbsp;</td>
						</tr>
						<tr>
			...
			<tr>
				<td align ="center" valign="top" width="50%" colspan="2"><br><u><b>Ahli Jawatankuasa Pembiayaan</b></u><br><br>
				</td>
			</tr>
			<tr><td class="padding1" colspan="2" style="border-top:#000000 solid 1px;border-bottom:#000000 solid 1px;">&nbsp;</td></tr>
			<tr>
			<tr>
				<td align ="center" valign="top" width="50%" colspan="2"><br><u><b>KEPUTUSAN RESMI</b></u><br><br>
				</td>
			</tr>
			<tr>
				<td colspan="2">
					<table cellpadding="0" cellspacing="0" width="100%">
						<tr>
							<td width="34%"><b>LULUS/TOLAK: '.$stat.'</b></td>
							<td width="33%">JUMLAH: '.number_format($amtLoan,2).'</td>
							<td width="33%">TEMPOH: '.$loanPeriod.' bulan</td>
						</tr>
						<tr>
							<td width="34%">Syarat/Sebab-sebab:</td>
							<td width="33%">&nbsp;</td>
							<td width="33%">&nbsp;</td>
						</tr>
						<tr>
							<td width="34%">Tarikh:</td>
							<td width="33%">Setiausaha:</td>
							<td width="33%">&nbsp;</td>
						</tr>
					</table>
				</td>
