...
print'
	<tr>
	  ...
	  <td class="Data" >&nbsp;'; if ($IDtype == $rs->fields(ID)) { print '&nbsp;<input size="7" name="YuranP" value="'.$rs1->fields(monthFee).'" >';
	  }else{ print '&nbsp;'.$rs1->fields(monthFee).''; }
	  print' </td>
	        <td class="Data" align="right" >&nbsp;'; if ($IDtype == $rs->fields(ID)) { print '&nbsp;<input size="15" name="noAmt" value="'.$rs->fields(jumBlnP).'" >';
