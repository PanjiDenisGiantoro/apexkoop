			...
			<td valign="top">
				<table border="0" cellspacing="1" cellpadding="2" width="100%" class="table table-sm table-striped">
					<tr class="table-primary">
						...
						<td nowrap height="20" colspan="2" nowrap><div align="right"><b>Simpanan Yuran Dan Syer (RM)</b></div></td>

					</tr>
					<tr class="table-primary">
						<td nowrap align="center" height="20"><b>Bil</b></td>
						<td nowrap><b>No./Nama Anggota</b></td>
						<td nowrap align="center"><b>Kad Pengenalan</b></td>

						<td nowrap align="right"><b>Baki Awal Tahun '.$yy.' (Yuran)</b></td>
						<td nowrap align="right"><b>Syer</b></td>
					</tr>';	
		$totalFees = 0;
		$totalShares = 0;
