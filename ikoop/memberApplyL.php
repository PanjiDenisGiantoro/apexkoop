...
// $a++;
// $FormLabel[$a]   	= "Alamat Cawangan / Kawasan / Zon";
...
<h5 class="card-title"><font class="text-primary">
<img src="images/number1-primary.png" width="17" height="17">&nbsp;ISI PROFIL</font>&nbsp;<i class="mdi mdi-arrow-right-bold-outline"></i>&nbsp;
<img src="images/number2.png" width="17" height="17">&nbsp;PEMBAYARAN&nbsp;<i class="mdi mdi-arrow-right-bold-outline"></i>&nbsp;
<img src="images/number3.png" width="17" height="17">&nbsp;SELESAI<br/><br/>
...
<br><small>(?) No. Anggota yang telah diluluskan.</small></h5>
