...
<tr>
	<td colspan="3">
		<table border="0" cellspacing="1" cellpadding="2">
			<tr><td>No. Jurnal</td><td valign="top">:</td><td><input name="dateTxt" type="text" size="20" maxlength="50" /></td></tr>
			<tr><td>Tarikh</td><td valign="top">:</td><td><input name="dateTxt" type="text" size="20" maxlength="10" /></td></tr>
		</table>
	</td>
</tr>
...
<tr>
	<td colspan="3">
		Jenis&nbsp;<select name="loanTxt" type=""><option>PINJAMAN</option></select>&nbsp;
		No.Bond&nbsp;<input name="bondTxt" type="text" size="10" maxlength="50" />&nbsp;
		No.Anggota&nbsp;<input name="memberIDTxt" type="text" size="10" maxlength="50" />&nbsp;
...
<tr>
	<td width="60%" valign="top">
		<table border="0" cellspacing="1" cellpadding="3">
			<tr><td nowrap="nowrap">Disediakan Oleh</td><td valign="top">:</td><td><select><option>NOR AZEAN BTE MD SIN</option></select></td></tr>
			<tr><td nowrap="nowrap">Disahkan Oleh</td><td valign="top">:</td><td><select><option>JOHANAH BINTI SULI</option></select></td></tr>
			<tr><td nowrap="nowrap" valign="top">Keterangan</td><td valign="top">:</td><td valign="top"><textarea cols="50" rows="4">PELARASAN PEMBIAYAAN TUNAI DENGAN MODAL YURAN SYER ANGGOTA BERHENTI ROSMAN AHMAD NAMAHURI</textarea></td></tr>
		</table>
	</td>
	<td>&nbsp;</td>
	<td width="40%" align="right" valign="top">
		<table border="0" cellspacing="1" cellpadding="2">
			...
			<tr><td nowrap="nowrap">Kod Caw.</td><td valign="top">:</td><td><input name="" type="text" size="20" maxlength="50" /></td></tr>
			<tr><td nowrap="nowrap">No.Siri</td><td valign="top">:</td><td><input name="" type="text" size="20" maxlength="50" /></td></tr>
			<tr><td nowrap="nowrap">Tarikh</td><td valign="top">:</td><td><input name="" type="text" size="20" maxlength="50" /></td></tr>
		</table>
	</td>
</tr>
<?
