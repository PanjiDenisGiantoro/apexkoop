...
AND get_session("Cookie_groupID") <> 5
...
$sFileName = "?vw=memberMOF&mn=$mn";
$sFileRef  = "?vw=memberEdit&mn=$mn";
$title     = "Profil Koperasi CODE";
...
$sWhere .= " AND b.jenisCode = " . tosql(2019, "Number");
if ($filter == 1) {
...
.'<h5 class="card-title">'.strtoupper($title).'</h5>';
	...
	print '
	<tr valign="top">
		<td align="left"><input type="button" class="btn btn-sm btn-primary" value="Statistik" onClick="ITRActionButtonClickStatistik(\'statistik\');">';
	...
	function ITRActionButtonClickStatistik(v) {
	      ...
	      if(e==null) {
	        ...
	        if(count==0) {
	          ...
	          //e.submit();
	          window.location.href ="?vw=statMOFdetails&mn=900&pk=" + strStatus;
			//   }
	        }
	      }
	    }
