...
$sSQL = "";
$sSQL = "SELECT a.name, b.memberID, b.approvedDate, b.newIC, b.job, b.address, b.postcode, b.city, b.totalFee, c.name AS negeri, b.isApprovedTDate
		...
		<td>
			<table border="0" cellpadding="2" cellspacing="1" align=left width="100%">
							<tr bgcolor="#C0C0C0" style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt; font-weight: bold;">
								<th nowrap>&nbsp;</th>
								<th nowrap width="">&nbsp;No Anggota</th>
								<th nowrap align="left">&nbsp;Nama</th>
								<th nowrap width="">&nbsp;No. KP</th>
				...
				if ($rs->RowCount() <> 0) {	
					while(!$rs->EOF) {	
						if ($tempDept <> $rs->fields(department)) {
							...
							<tr bgcolor="#C0C0C0" style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt; font-weight: bold;">
								<th nowrap>&nbsp;</th>
								<th nowrap width="100">&nbsp;No Anggota</th>
								<th nowrap align="left">&nbsp;Nama</th>
								<th nowrap width="80">&nbsp;No. KP</th>
