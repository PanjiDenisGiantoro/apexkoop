...
<table border="0" cellpadding="5" cellspacing="0" width="100%">
	...
	<tr><td colspan=3>&nbsp;NAMA KOPERASI : KOUNISEM</td>
	</tr>
		...
		<td colspan="5">
				...
				print '
						<tr style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt;" bgcolor="FFFFFF">
							...
							//if it is zero than set it to null
							else{$totalpercent = 0;}//is set to null 
							...
							//if it is zero than set it to null
							else{$totalpercent1 = 0;}//is set to null
							...
							//if it is zero than set it to null
							else{$totalpercent2 = 0;}//is set to null
