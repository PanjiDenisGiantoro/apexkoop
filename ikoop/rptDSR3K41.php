...
$title  = 'Kelulusan Pembiayaan RM0-RM3000 Lulus (>40%)';
...
$sSQL = "SELECT a.*,b.*,c.grossPay, DATEDIFF(a.applyDate,b.ajkDate2)as date1
		...
		AND (b.gajiTot <= 3000) AND (a.Nisbahdsr >40)
		ORDER BY date1 ASC";
			...
			<table border=0  cellpadding="2" cellspacing="1" align=left width="100%" bgcolor="999999">
				...
				if ($rs->RowCount() <> 0) {	
					while(!$rs->EOF) {	
						...
						$dsr41 = dlookup("loans", "Nisbahdsr", "loanID=" . tosql($rs->fields(loanID), "Text"));	
