...
$sSQL1      = "SELECT ID, name FROM generalacc WHERE category = 'AC'";
...
print'
        ...
        <div class="word-trans">
            <tr>
                <td>MEMAPARKAN SEMUA BAKI SYARIKAT PENGHUTANG PADA TAHUN '.$yr.'
                    <small style="display: block; padding-top: 0px; position: relative; top: -5px;">
                        <i style="font-weight: normal; font-size: 10px; letter-spacing: 2px; display: inline-block;">
                            SHOWING ALL BALANCES OF DEBTOR COMPANIES IN YEAR '.$yr.'
                        </i>
                    </small>
                </td>
            </tr>
...
print '
<!---Signature--->
  <div class="font7 footer bottom" align="center">Ini adalah cetakan komputer dan tidak perlu ditandatangan
