...
if($generate) {
	...
	$link =  '<a href="/staging/DIVIDEN/'.$fname.'">'.$fname.'</a>';
}else{
			...
			<td valign="top">
				<table border="0" cellspacing="1" cellpadding="2" width="100%" class="table table-sm table-striped">
					...
					<tr class="table-primary">
						<td align="center" nowrap><b>Bil</b></td>
						<td align="left"   nowrap><b>Nombor - Nama Anggota</b></td>
						<td align="center" nowrap><b>Kad Pengenalan</b></td>
						<td align="center" nowrap><b>Akaun Bank</b></td>
						<td nowrap align="right"><b>Dividen Tahun '.$yy.' (RM)</b></td>
					</tr>';	
		$totalFees = 0;
		$totalShares = 0;
