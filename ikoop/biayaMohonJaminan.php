...
$sFileName		= "?vw=biayaMohonJaminan&mn=5";
$sActionFileName= "?vw=biayaMember&mn=5";
...
//-----------------
	...
	if ($i == 1) {
		if($status < 4){
		print '
		<input type="button" class="btn btn-sm btn-secondary" value="..." onclick="window.open(\'selToJaminan.php?refer=d&obj=1\',\'sel\',\'top=10,left=10,width=750,height=500,scrollbars=yes,resizable=yes,toolbars=no,location=no,menubar=no\');">
		&nbsp;';			
	...
	if ($i == 3) {
		if($status < 4){
		print '
		<input type="button" class="btn btn-sm btn-secondary" value="..." onclick="window.open(\'selToJaminan.php?refer=d&obj=2\',\'sel\',\'top=10,left=10,width=850,height=500,scrollbars=yes,resizable=yes,toolbars=no,location=no,menubar=no\');">
		&nbsp;';
	...
	if ($i == 5) {
		if($status < 4){
		print '
		<input type="button" class="btn btn-sm btn-secondary" value="..." onclick="window.open(\'selToJaminan.php?refer=d&obj=3\',\'sel\',\'top=10,left=10,width=850,height=500,scrollbars=yes,resizable=yes,toolbars=no,location=no,menubar=no\');">
		&nbsp;';
