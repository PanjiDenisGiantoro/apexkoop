...
$strTemp .=
'<div><h5 class="card-title m-3 mt-3">'.$strHeaderTitle.'</h5></div>'
...
if ($page <> 'list') {
	...
	'<tr>'
		.'<td colspan="2">'
			.'<table class="table table-bordered table-striped table-sm" style="font-size: 8pt;" cellpadding="0" cellspacing="6">';
	...
	$strFieldNameList = array('Nama', 'No. Anggota', 'Jenis', 'Jumlah');

	if ($GetData->RowCount() <> 0) {
		
		$fLoanAmount = $_REQUEST['loanAmt'];
		echo $fLoanAmount;
		$fProfitRate = $_REQUEST['loanCaj'];
		$nLoanMonth = $_REQUEST['loanPeriod'];
	...
	$strFieldNameList[1]	= array('<b>Tahun</b>', '&nbsp;', '<b>Untung Tahunan</b>', '<b>Untung Bulanan</b>', '<b>Pokok Tahunan</b>', '<b>Pokok Bulanan</b>', '<b>Jumlah Tahunan</b>', '<b>Jumlah Bulanan</b>');
	$strFieldWidthList[1]	= array('50', '50', '80', '80', '80', '80', '80', '80');
	...
	*/
	...
	$strTemp .='<table class="table table-sm" border="0" style="font-size: 8pt;" cellpadding="0" cellspacing="0">'
					.'<tr>'
						.'<td valign="top">'
...
function BeginDataField($strFieldNameList_, $strFieldWidthList_) {
	$strTemp_ = '<table border="0" cellspacing="1" cellpadding="4" width="100%" class="table table-bordered table-striped table-sm" style="font-size: 8pt;">'
