...
if ($by == 1)	print '<option value="1" selected>No. Kakitangan</option>'; 	else print '<option value="1">No. Kakitangan</option>';				
if ($by == 2)	print '<option value="2" selected>ID Kakitangan</option>'; 	else print '<option value="2">ID Kakitangan</option>';				
if ($by == 3)	print '<option value="3" selected>Aktiviti</option>'; 	else print '<option value="3">Aktiviti</option>';							
print '		</select>
			...
			<td valign="top">
				<table border="0" cellspacing="1" cellpadding="2" width="100%" class="table table-sm table-striped">
					<tr class="table-danger">
						...
						<td nowrap><b>Aktiviti</b></td>
						<td nowrap align="center"><b>Tarikh</b></td>
						<td nowrap align="center"><b>Masa</b></td>
						<td nowrap align="center"><b>No. Kakitangan</b></td>
						<td nowrap><b>ID Kakitangan</b></td>
					</tr>';	
