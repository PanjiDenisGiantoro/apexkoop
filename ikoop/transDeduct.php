...
if ($page <> 'list') {
	...
	$strFieldNameList = array('Nama', 'No. Anggota', 'No. KP', 'Jabatan/Cawangan', 'Tarikh Keanggotaan');
...
//set list header 
	if ($GetData->RowCount() <> 0) {
		$strFieldNameList = array($strCheckboxTemp, 'No.Anggota/Nama', 'No. KP Baru', 'Jabatan/Cawangan', 'Tarikh Anggota', 'Bil. Rekod', 'Jumlah (RM)');
	} else {
		$strFieldNameList = array('&nbsp;', 'No.Anggota/Nama', 'No. KP Baru', 'Jabatan/Cawangan', 'Tarikh Anggota', 'Bil. Rekod', 'Jumlah (RM)');
	}
