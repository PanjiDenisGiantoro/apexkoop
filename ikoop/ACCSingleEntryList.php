...
if ($by == 2)	print '<option value="2" selected>No. Rujukan</option>'; 	else print '<option value="2">No. Rujukan</option>';				
...
print '		</select>
			...
			&nbsp;&nbsp;			
			<!--Kod Potongan
			<select name="code" class="form-select-xs" onchange="document.MyForm.submit();">
...
print '		</select>&nbsp;
			Status
			<select name="filter" class="btn btn-sm btn-secondary" onchange="document.MyForm.submit();">';
			...
			<td valign="top">
				<table border="0" cellspacing="1" cellpadding="2" width="100%" class="table table-sm table-striped">
					<tr class="table-primary">
						...
						<td nowrap><b>Nama Batch</b></td>
						<td nowrap align="center"><b>Status Kunci</b></td>
...
if ($GetBaucers->fields(g_lockstat) == 1){
	print'	<td class="Data"><input type="checkbox" class="form-check-input" name="pk[]" value="'.tohtml($GetBaucers->fields(SENO)).'">
	...
	print'	<td class="Data" align="center">'.$tarikh_entry.'</td>
			<td class="Data">'.$nama.'</td>
			<td class="Data" align="center"><font class="'.$colorPen.'">'.$lock.'</font></td>
			</tr>';
		$cnt++;
		$bil++;
		$GetBaucers->MoveNext();
