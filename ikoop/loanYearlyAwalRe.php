...
$sql = "select loanType FROM `loans` where status ='3' AND loanID = '".$pk."'"; 	
				...
				<tr style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt;" bgcolor="FFFFFF">
					...
					<td width="10%" align="right">&nbsp;&nbsp;</td>
						...
						<tr style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt;" bgcolor="FFFFFF">
							...
							<td width="10%">&nbsp;</td>
							<td align="left">Jumlah Potongan (POKOK) Sehingga Tahun '.$yy.' Bulan '.$mm2.'</td>
							<td width="10%" align="right">';
						...
						<tr style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt;" bgcolor="FFFFFF">
							...
							<td width="10%" align="center"></td>
							<td width="10%">&nbsp;</td>
							<td align="left">Caj Sebulan Keuntungan </td>
							<td width="10%" align="right">';
