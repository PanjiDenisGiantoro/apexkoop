	...
	<tr>
		<td colspan="5">
			<table border=0  cellpadding="2" cellspacing="1" align=left bgcolor="999999">
				<tr bgcolor="#008080" style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt; font-weight: bold;">
...
//'.number_format($debit,2).'
	...
	<tr style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt;" bgcolor="FFFFFF">
	<td colspan="1" align="right"><b>Jumlah Aset (RM) &nbsp;</b></td>
	<td align="right">'.number_format($totalbalance,2).'</td>
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////keuntungan terkumpul//////////////////////////////////////////////////
		...
		if ($rs2aa->fields(ID) == '1140') {
			...
			print'<td width="0%"  align="right">'.number_format($kredit1,2).'</td>';
		}

		if ($rs2aa->fields(ID) == '1140') {
		print'<td width="5%"  align="right">'.number_format($balance1KU,2).'</td>';
		}else {
		print'<td width="5%"  align="right">'.number_format($balance1,2).'</td>';
		}
		...
		$totalkreditA1 = ($totalkredit1 + $TUntungTM);
	...
	$totalbalance1 = ($totalkreditA1 - $totaldebit1);
	...
	print '
		...
		<td align="right">'.number_format($totalkreditA1,2).'</td>
		...
		<tr style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt;" bgcolor="FFFFFF">
		<td colspan="1" align="right"><b>Jumlah Ekuiti (RM) &nbsp;</b></td>
		<td align="right">'.number_format($totalbalance1,2).'</td>
		<td colspan="2" align="right">&nbsp;</td>
		</tr>';
	} else {
...
print '</table> 
	...
	print '
		...
		<tr style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt;" bgcolor="FFFFFF">
		<td colspan="1" align="right"><b>Jumlah Liabiliti (RM) &nbsp;</b></td>
		<td align="right">'.number_format($totalbalance2,2).'</td>
		<td colspan="2" align="right">&nbsp;</td>
		</tr>';
...

		...
		<tr style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt;" bgcolor="FFFFFF">
		<td colspan="1" align="right"><b>Jumlah Liabiliti + Ekuiti (RM) &nbsp;</b></td>
