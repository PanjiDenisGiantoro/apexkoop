...
$caj = 1;
$redirectlink = 'https://app.ikoop.com.my/staging/getApi.php';
...
// $url = "htps://rcbdev.assidqlink.com/rcb/webservice/rest/DoTrading.php";
//
// $url = "http://api.swipego.io/api/payment-links";
...
$headers = array(
    ...
    "Authorization: Bearer 823|V01uwzlQP0NkEsZapMGdWGkmiSKZe6BlZfwLRKCF",
);
