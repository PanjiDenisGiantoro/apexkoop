...
$title  = 'Kelulusan Pembiayaan RM3001-RM5000 Lulus';
...
$sSQL = "SELECT a.*,b.*,c.grossPay, DATEDIFF(a.applyDate,b.ajkDate2)as date1
		...
		AND (b.gajiTot >= 3001 AND b.gajiTot <=5000)
		ORDER BY date1 ASC";
				...
				if ($rs->RowCount() <> 0) {	
					while(!$rs->EOF) {	
						...
						<tr style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt;" bgcolor="FFFFFF">
							...
							if ($dsr40 <= 40){
								print'<td width="2%" align="right">'.$dsr40.'&nbsp;</td>';
							}
								else{ 
					 				print'<td width="2%" align="right">&nbsp;</td>';
								}
