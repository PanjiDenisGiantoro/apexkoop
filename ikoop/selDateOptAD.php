...
print '			</select>
				<input type="text" name="yyFrom" size="5" maxlength="4" value="'.$yyFrom.'" class="form-control-sm">
			</td>
...
print '			</select>
				<input type="text" name="yyTo" size="5"maxlength="4" value="'.$yyTo.'" class="form-control-sm">
			</td>

		</tr>
		<tr> 
			<td align="center" ><b>Pilih Akaun</b></td>
			<td >'.$strSelect.' 
				<input type="text" name="kod_akaun2"  size="10" maxlength="10" value="'.$kod_akaun2.'" class="form-control-sm">
