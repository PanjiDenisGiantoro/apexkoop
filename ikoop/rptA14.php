...
<table border="0" cellpadding="5" cellspacing="0" width="100%">
	...
	<tr bgcolor="#730b33" style="font-family: Arial, Helvetica, sans-serif; font-weight: bold;">
		<td align="center" height="40"><font color="#FFFFFF">' . $title . ' Pada ' . date("d/m/Y") . '
		</td>
	</tr>
	<tr>
	...
	while (!$GetData->EOF) {
		...
		print '
						<tr style="font-family: Arial, Helvetica, sans-serif; font-size: 10pt;">
							...
							<td align="center">' . $GetData->fields('mobileNo') . '</td>
		...
		print '</td>
						...
						<td align="center">' . $GetData->fields('w_contact1') . '</td>
