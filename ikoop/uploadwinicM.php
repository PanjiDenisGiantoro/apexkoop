...
	
	...
	if ((in_array($file_ext,$allowed_file_types) && ($filesize < 5048576)) OR (in_array($file_ext1,$allowed_file_types1) && ($filesize1 < 5048576)))
	{	
		// Rename file
				...
				<td class="Data">
					<table width="100%">
						<tr>
							...
							<br></br>
							<b>Masukkan Fail Kad Pengenalan</b> (Saiz Maksimum: '.$max_size.' bytes/'.($max_size/5024).' kb):<br>
							<input type="file" name="filename"><br></br>
							<input type="hidden" name="action" value="upload">
							
							<b>Masukkan Fail Pengesahan Jawatan</b> (Saiz Maksimum: '.$max_size.' bytes/'.($max_size/5024).' kb):<br>
