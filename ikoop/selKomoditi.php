...
<script language="JavaScript">
	function selPinjaman(memberID,name,loan_no,id,amt)
	{	
...
<table border="0" cellspacing="1" cellpadding="0" width="95%" align="center" class="table table-sm table-light">
	<tr>
		<td class="Data">
			<table border="0" cellspacing="1" cellpadding="3" width="100%" align="center" class="table table-sm" style="font-size: 9pt;">
				<tr>
					<td class="table-light" colspan="2">Senarai Pembiayaan Lulus</b></td>
				</tr>
	<tr valign="top">
		<td align="left" >
			Carian melalui
...
if ($GetLoan->RowCount() == 0) {
	print '		<tr><td	class="Label" align="center" height=50 valign=middle>
					<b>- Sila masukkan No / Nama Anggota ATAU pilih Cawangan/Kawasan/Zon  -</b>
				</td></tr>';
} else {				
	if ($GetLoan->RowCount() <> 0) {  
		$bil = $StartRec;
		...
		print '	<tr>
				...
				<table border="0" cellpadding="2" cellspacing="1" style="font-size: 9pt;" width="100%" class="table table-sm table-striped">
					<tr class="table-primary">
						<td nowrap>&nbsp;</td>
						<td nowrap><b>No. Rujukan Pinjaman</b></td>
						<td nowrap><b>No./Nama Anggota</b></td>
						<td nowrap align="center"><b>Kad Pengenalan</b></td>
						<td nowrap align="center"><b>No. Rujukan</b></td>
...
//-------------------
		...
		print '	<tr>
						...
						<td	class="Data"><a href="javascript:selPinjaman(\''.$memberID.'\',\''.$nama_anggota.'\',\''.$loan_no.'\',\''.$id.'\',\''.$amt.'\');">'.$GetLoan->fields(loanNo).'-&nbsp;'.dlookup("general", "name", "ID=" . tosql($GetLoan->fields(loanType), "Number")).'</a></td>
						...
						<td	class="Data" align="center">'.$loan_no.'</td>
