...
if (get_session("Cookie_groupID") <> 0 OR get_session("Cookie_koperasiID") <> 0) {
	...
	if ($GetLoan->RowCount() <> 0) {  
	    ...
	    <tr valign="top" >
			...
			<tr class="table-primary">
						<td nowrap>&nbsp;</td>
						<td nowrap align="left"><b>No. Rujukan/Pembiayaan</b></td>
...
if($GetLoan->fields(statuspID1)) $approve1 = '<i class="mdi mdi-check text-primary"></i>'; else $approve1 = '<i class="mdi mdi-close text-danger"></i>';
if($GetLoan->fields(statuspID2)) $approve2 = '<i class="mdi mdi-check text-primary"></i>'; else $approve2 = '<i class="mdi mdi-close text-danger"></i>';
if($GetLoan->fields(statuspID3)) $approve3 = '<i class="mdi mdi-check text-primary"></i>'; else $approve3 = '<i class="mdi mdi-close text-danger"></i>';
print ' <tr>
