...
$title  = 'Ringkasan Dividen Anggota Mengikut Pegangan Yuran Pada Bulan&nbsp;'.displayBulan($month).'&nbsp; Tahun '.$yr ;
...
<table border="0" cellpadding="5" cellspacing="0" width="100%">
	...
	<tr>
		<td><font size=1>Cetak Pada : '.$today.'<br />Oleh : '.get_session('Cookie_fullName').'</font></td>
			...
			<table border=0  cellpadding="2" cellspacing="1" align=left width="100%" class="table table-striped table-sm" style="font-family: Arial, Helvetica, sans-serif; font-size: 9pt; font-weight: bold;">
			<tr bgcolor="#C0C0C0" style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt; font-weight: bold;">
					...
					<td width="250" align="left" nowrap><b>No. Anggota- Nama<b></td>
					<td width="100" align="left" nowrap><div align="right"><b>Yuran Bulanan (RM)<b></div></td>
					<td width="70" align="left" nowrap><div align="right"><b>Bayaran Dividen Syer (RM)'.$rsCheck->fields(amtFee).'%<b></div></td>
					<td nowrap align="center" width="70"><div align="right"><b>Bayaran Dividen Tabungan (RM)  '.$rsCheck->fields(amtShare).'%<b></div></td>
';
				//$total = 0;
