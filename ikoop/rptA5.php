...
$title  = 'Senarai Maklumat Simpanan Koperasi';
				...
				if ($rs->RowCount() <> 0) {	
					while(!$rs->EOF) {	
						if ($tempDept <> $rs->fields(department)) {
							...
							print '
							<tr><td colspan="8"  style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt; font-weight: bold;" height="30" valign="bottom">
							...
							<tr bgcolor="#C0C0C0" style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt; font-weight: bold;">
								...
								<td nowrap rowspan="2" width="100">&nbsp;No Anggota</td>
								<td nowrap rowspan="2" align="left">&nbsp;Nama</td>
								<td nowrap rowspan="2" width="80">&nbsp;No. KP Baru</td>
								<td nowrap rowspan="2" width="80">&nbsp;No. KP Lama</td>
