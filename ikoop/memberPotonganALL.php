...
//$GetMember = ctMemberStatusDept($q,$by,"1",$dept);
	$sSQL = "";
	$sWhere = " a.userID = b.userID AND b.status IN (1) AND b.statusHL NOT IN (1)";
			...
			<td>
				<table width="100%">
					<tr>
						...
						<input type="button" class="btn btn-secondary" value="Generate PGB" onclick="window.location.href=\'?vw=PreviewPGB&mn='.$mn.'\'">
...
print '  <tr valign="top" >
			<td valign="top">
				<table border="0" cellspacing="1" cellpadding="2" width="100%" class="table table-sm table-striped">
					...
					<tr class="table-primary">
						...
						<td nowrap><b>Cawangan/Kawasan/Zon</b></td>
						<td nowrap><b>No. Akaun Tabungan</b></td>
						<td nowrap align="right"><b>Jumlah Potongan Bulanan (RM)</b></td>
		...
		while (!$GetMember->EOF && $cnt <= $pg) {
			...
			print ' <tr>
						...
						<td class="Data">'.$GetMember->fields('accTabungan').'</td>	
						<td class="Data" align="right">'.number_format($jumALL,2).'</td>							
