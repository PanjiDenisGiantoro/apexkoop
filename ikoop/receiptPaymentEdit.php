...
<tr>
	<td width="48%">
		<table border="0" cellspacing="1" cellpadding="2">
			<tr>
				<td valign="top">No.</td>
				<td valign="top">:</td><td><input name="" type="text" size="20" maxlength="50" /></td>
			</tr>
		</table>
	</td>
	<td valign="top">&nbsp;</td>
...
<tr>
	<td valign="top">
		<table border="0" cellspacing="1" cellpadding="2">
			...
			<tr><td valign="top">Nama</td><td valign="top">:</td><td><input name="" type="text" size="50" maxlength="50" /></td></tr>
			<tr><td valign="top">Nama</td><td valign="top">:</td><td><textarea cols="50" rows="4">NO. 266 & 267, JLN BANDAR 12, TAMAN MELAWATI, 53100 ULU KELANG, SELANGOR</textarea></td></tr>
		</table>
	</td>
	<td valign="top">&nbsp;</td>
...
<tr>
	<td width="60%" valign="top" colspan="3">
		<table border="0" cellspacing="1" cellpadding="3">
			<tr><td colspan="3" nowrap="nowrap">Jumlah Dalam Perkataan<br /><input name="" size="80" maxlength="80" value="Satu Ribu Satu Ratus Empat Puluh Dua Sahaja."></td></tr>
			<tr><td nowrap="nowrap">Kerani Kewangan</td><td valign="top">:</td><td><select><option>RAMLI BIN MOHD SALLEH</option></select></td></tr>
			<tr><td nowrap="nowrap" valign="top">Catatan</td><td valign="top">:</td><td valign="top"><textarea cols="50" rows="4"></textarea></td></tr>
		</table>
	</td>
</tr>
<?
