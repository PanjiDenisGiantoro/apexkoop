...
//$conn->debug =1;
if($q) $getQ = " AND no_bayar like '%".$q."%'"; else $getQ = '';
...
print '		</select>
    ...
    <tr valign="top" class="Header">
	   	<td align="left" >
		Carian Melalui <input type="text" name="q" value="" maxlength="100" size="20" class="form-control-sm">
			...
			<td valign="top">
				<table border="0" cellspacing="1" cellpadding="2" width="100%" class="table table-striped table-sm">
					<tr class="table-primary">
						<td nowrap>&nbsp;</td>
						<td nowrap><b>No. Bayar</b></td>
						<td nowrap align="center"><b>Tarikh</b></td>
						<td nowrap align="center"><b>Bil. Data</b></td>
						<!--td nowrap><b>No. Siri</b></td-->
						<td nowrap align="right" width="50"><b>Jumlah (RM)</b></td>
					</tr>';	
