...
$sFileName		= "?vw=biayaMohonJaminan&mn=906";
$sActionFileName= "?vw=biayaMember&mn=906";
...
if(dlookup("loans", "statuspID1", "loanID= '" . $pk . "'")) $approve1 = '<img src="images/sym-tick-red-bkrm-01.gif" height="20" width="20">'; else $approve1 = '<img src="images/delete.jpg" height="15" width="15">';

if(dlookup("loans", "statuspID2", "loanID= '" . $pk . "'")) $approve2 = '<img src="images/sym-tick-red-bkrm-01.gif" height="20" width="20">'; else $approve2 = '<img src="images/delete.jpg" height="15" width="15">';

if(dlookup("loans", "statuspID3", "loanID= '" . $pk . "'")) $approve3 = '<img src="images/sym-tick-red-bkrm-01.gif" height="20" width="20">'; else $approve3 = '<img src="images/delete.jpg" height="15" width="15">';
...
for ($i = 1; $i <= count($FormLabel); $i++) {
	...
	if ($i == 1) print '<tr><td class=Header colspan=4>1. Penjamin pertama</td></tr>';
	if ($i == 3) print '<tr><td class=Header colspan=4>2. Penjamin kedua</td></tr>';
	if ($i == 5) print '<tr><td class=Header colspan=4>3. Penjamin ketiga</td></tr>';
...
$sActionFileName= "?vw=biayaDokumen&mn=906&pk=".$loID;
print '<tr><td colspan=4 align=center class=Data>
			<input type="hidden" name="pk" value="'.$loID.'">
			<input type=Submit name=SubmitForm class="btn btn-secondary" value=Simpan>
			<input type=button name=ResetForm class="btn btn-secondary" value=Kembali onClick="window.location.href =\''.$sActionFileName.'\'">
			</td></tr></table></form>';
include("footer.php");
print '
