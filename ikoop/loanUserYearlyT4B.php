...
*          Filename		: 	loanUserYearlyT4B.php
*          Date 		: 	12/09/2006
*********************************************************************************/
session_start();
include("common.php");	
...
$title  = 'Penyata Tuntutan (T4) Bagi '. $nama_Pembiayaan .' ('.$loanNo.') Pada Bulan '.$mm.' Tahun '.$yr;
		...
		<td colspan="2">
			<table border=1  cellpadding="2" cellspacing="0" align=left width="100%">
					...
					while(!$rs->EOF) {	
						...
						<tr style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt;" bgcolor="FFFFFF">
							...
							<td align="left">&nbsp;'.dlookup("general", "name", "ID=" . tosql($rs->fields(deductID), "Number")).'</td>';
							 ...
							 print'</td>
							<td width="10%" align="right">&nbsp;'.number_format($kreditNew,2).'</td>
						</tr>';
					//$rs->MoveNext();
				//	}	
					$sumDebit = $kreditNew + $blnLewat;
				...
				print '						<tr style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt;" bgcolor="FFFFFF">
							...
							<td width="12%" align="center">&nbsp;'.$today.'</td>
							<td width="10%">&nbsp;</td>
							<td align="left">&nbsp;CAJ LEWAT <b>'.$bulanLewat.'</b> BULAN X 1%</td>';
