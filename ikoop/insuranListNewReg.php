...
<table border="0" cellspacing="1" cellpadding="3" width="100%" align="center">
			...
			<td	valign="top">
				<table border="0" cellspacing="1" cellpadding="2" width="100%" class="table table-sm table-striped">
					<tr class="table-primary">
						...
						<td	nowrap align="center"><b>No. Kenderaan</b></td>
		...
		while (!$GetListIns->EOF && $cnt <= $pg) {
			...
			print '	<tr>
						...
						<td	class="Data" align="center">'.$dateApply.'</td>
						  ...
						  if ($code == '2' && $ID == $insuranID) {}else{
						  if($pgview !="viewsah"){$sFileName= $sFileName."&";}else{$sFileName= $sFileName."&";}
						...
						print '  </td>
						  <td class="Data" align="center">'; 
						  if ($code == '2' && $ID == $insuranID) { print '<input size="7" type="hidden" name="IDedit" value="'.$insuranID.'" ><input type="submit" size="3" onClick="if(!confirm(\'Adakah ada pasti untuk Kemaskini rekod ini?\')) {return false} else {window.MyForm.submit();};" name="edit" class="btn btn-sm btn-primary" value="edit" />';
						  }
						print ' 
						</tr>';
				$cnt++;
	...
	<td valign="top"><table  width="100%" border="0" cellspacing="0" cellpadding="0" ><tr><td width="50%">
		<table border="0" cellspacing="1" cellpadding="3">
			...
			<tr><td nowrap="nowrap">Tarikh</td><td valign="top"></td><td>'.$idSediaDate.'</td></tr>';
			}else{
			print '
