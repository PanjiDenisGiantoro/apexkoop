...
if (isset($_POST['SubmitForm']) && $agree <> "") { alert("prosese");
...
';
                ...
                if(@$uplgaji!='' && @$uplgaji!='0'){ $lnkgaji='<a href="upload_gaji/'.$uplgaji.'" class="text-primary" target=blank><i class="far fa-file-pdf text-danger"></i> Lampiran Slip Gaji</a>'; } else { $lnkgaji=''; }
                
                $uplkp = dlookup("userloandetails", "ic_img", "userID=" . tosql($pk, "Text"));
                if(@$uplkp!='' && @$uplkp!='0'){ $lnkkp='<a href="upload_ic/'.$uplkp.'" class="text-primary" target=blank><i class="far fa-file-pdf text-danger"></i> Lampiran Kad Pengenalan</a>'; } else { $lnkkp=''; }
