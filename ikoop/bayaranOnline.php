...
<table cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><p><p>Bagi  membolehkan kami memberikan perkhidmatan yang terbaik kepada anggota,  sila pastikan langkah-langkah berikut diikuti, iaitu :-</p>
      ...
      <p> 3. Penambahan minima yang boleh dibuat adalah sebanyak <b>RM 100.00</b>. Manakala penambahan maksima yang boleh dibuat adalah sebanyak RM29,999 <br>
      
      <p> 4. Caj transaksi sebanyak <b>RM 1.00</b> akan dikenakan untuk setiap transaksi yang dilakukan.<br>
        </p>
      
      <p> 5. Setelah bayaran dibuat, penyata anggota akan dikemaskini dalam dua hari bekerja. Sila semak di menu pengguna setelah dua hari membuat pembayaran. Sekiranya penyata tidak dikemaskini, sila hubungi pihak <b>DEMO</b> untuk tindakan lanjut.</p>
      ...
      <p> 7. Bayaran yang dibuat melalui <b><i>Payment Gateway</i> SWIPEGO (FINTECH WORLDWIDE SDN BHD)</b>.</p>
...
$FormType[$a]     = "radio";
$FormData[$a]     = array('Yuran','Syer');
$FormDataValue[$a]= array('1595','1596');
$FormCheck[$a]    = array();
$FormSize[$a]     = "1";
$FormLength[$a]   = "1";
...
if ($SubmitForm <> "") {
  ...
  print '<script>
          alert ("Sila Tunggu Sebentar Sementara Untuk Ke Paparan SWIPEGO");
