...
if($ID){
	...
	$sqltotal = "SELECT sum(pymtAmt) as tot FROM transactionHL WHERE docNo = '".$ID."'";
	$rstotal = $conn->Execute($sqltotal);
	$jumlah = $rstotal->fields(tot);
	
	$sql2 = "SELECT * FROM transactionHL WHERE docNo = ".tosql($ID, "Text")." ORDER BY ID";
...
print '
	...
	<tr><td colspan="3"><hr size="1px" /></td></tr>
	<tr><td colspan="3">&nbsp;</td></tr>
	<tr><td nowrap="nowrap" width="33%">Cara bayaran : <u>'.$cara_bayar.'</u></td><td nowrap="nowrap" width="33%" align="center" >Kod & No. siri : <u>'.$kod_siri.'&nbsp;</u></td><td nowrap="nowrap" width="33%" align="right">Tarikh Bayaran: <u>'.$tarikh.'</u></td></tr>
