...
if (!isset($q)) $q = '';
if (!isset($by)) $by = '1';
if (!isset($status)) $status = '2'; // Status "Selesai" set as 2
...
$status = isset($_GET['status']) ? $_GET['status'] : 2; // Status default
...
$GetData = ctTugasanKoperasiStatus($q, $by, $status, $dept, $dtFrom, $dtTo);
