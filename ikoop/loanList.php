...
<table border="0" cellspacing="0" cellpadding="3" width="100%" align="center">
    <tr>
		<td>
			...
			<? if ($GetLoan->RowCount() <> 0) { ?><hr size="1px"> <? } ?>
		</td>
	</tr>
<?
			...
			.'<td>'
				.'<table width="100%">'
					.'<tr>'
						...
						if ($pg == 5)	$temp .='<option value="5" selected>5</option>'; 	 	else $temp .='<option value="5">5</option>';				
						if ($pg == 10)	$temp .='<option value="10" selected>10</option>'; 		else $temp .='<option value="10">10</option>';				
						if ($pg == 20)	$temp .='<option value="20" selected>20</option>'; 		else $temp .='<option value="20">20</option>';				
						if ($pg == 30)	$temp .='<option value="30" selected>30</option>'; 		else $temp .='<option value="30">30</option>';				
						if ($pg == 40)	$temp .='<option value="40" selected>40</option>'; 		else $temp .='<option value="40">40</option>';				
						if ($pg == 50)	$temp .='<option value="50" selected>50</option>';		else $temp .='<option value="50">50</option>';				
						if ($pg == 100)	$temp .='<option value="100" selected>100</option>';	else $temp .='<option value="100">100</option>';				
	    ...
	    .'<tr valign="top">'
			.'<td valign="top">'
				.'<table border="0" cellspacing="1" cellpadding="2" width="100%" class="lineBG">'
					.'<tr class="header">'
						.'<td nowrap>&nbsp;</td>'
						.'<td nowrap>&nbsp;No. Pinjaman&nbsp;</td>'
						.'<td nowrap>&nbsp;No. Anggota/Nama Anggota&nbsp;</td>'
						.'<td nowrap align="center">&nbsp;No. KP Baru&nbsp;</td>'
