...
*/
				//----------------------------------------------------------------------------
					...
					<tr style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt;" bgcolor="FFFFFF">
						...
						<td align="right">&nbsp;<b>'; if ($percentTotalL==0) print '0'; else printf ("%.1f",$percentTotalL); print '%</b>&nbsp;&nbsp;&nbsp;</td>
						<td width="10">&nbsp;</td>

						<td align="right">&nbsp;<b>'.$totalP.'</b>&nbsp;</td>
						<td align="right">&nbsp;<b>'; if ($percentTotalP==0) print '0'; else printf ("%.1f",$percentTotalP); print '%</b>&nbsp;&nbsp;&nbsp;</td>
						<td width="10">&nbsp;</td>
