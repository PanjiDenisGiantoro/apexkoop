...
<br>Sukacita dimaklumkan bahawa ALM CORE SOLUTIONS SDN BHD (selepas ini disebut sebagai "Koperasi") akan menawarkan kemudahan '.$namaloan.' tertakluk kepada syarat seperti berikut:-</br></center>
<br>
<tr>
...
<td class="padding1" valign="top">&nbsp;:&nbsp;</td>
<td class="padding1" valign="top">Ansuran bulanan hendaklah dibayar melalui <b><u>potongan gaji bulanan</u></b>. Sekiranya potongan gaji bulanan tidak diperolehi, angggota membenarkan ALM CORE SOLUTIONS SDN BHD untuk memotong melalui <b><u>Potongan Akaun Tabungan</u></b>.</td>
</tr>
<br/><br/>
<tr>
...
<td class="padding1" valign="top">&nbsp;:&nbsp;</td>
<td class="padding1" valign="top">Sebarang pertukaran alamat hendaklah segera dimaklumkan kepada ALM CORE SOLUTIONS SDN BHD secara bertulis. Sebarang surat menyurat, notis atau tuntutan yang dihantar secara pos biasa atau berdaftar menggunakan alamat tersebut di atas atau alamat terakhir yang diketahui oleh ALM CORE SOLUTIONS SDN BHD hendaklah dianggap telah disampaikan dan diterima pada masa dan dengan cara pada kebiasaannya surat tersebut diserahkan.</td>
</tr>
<br/><br/>
<tr>
...
<td class="padding1" valign="top">&nbsp;:&nbsp;</td>
<td class="padding1" valign="top">
Sekiranya Pelanggan lewat membayar mana-mana ansuran sebagaimana yang ditetapkan di dalam Surat Tawaran ini, Pelanggan adalah bertanggungjawab untuk membayar pampasan kepada ALM CORE SOLUTIONS SDN BHD dikira pada kadar satu peratus (1%) setahun atas amaun tertunggak sepertimana ketetapan Bank Negara Malaysia. Amaun pampasan terhadap kelewatan membayar adalah dikira dari tarikh luput bayaran ansuran sehingga bayaran diterima oleh ALM CORE SOLUTIONS SDN BHD.
</td>
</tr>
<br/><br/>
<tr>
...
<td class="padding1" valign="top">
ALM CORE SOLUTIONS SDN BHD berhak memaklumkan status kedudukan pembiayaan ini kepada penjamin-penjamin pada bila-bila masa diperlukan sama ada bertulis atau lisan.(Sekiranya berkenaan)
</td>
</tr>
<br/>
<tr>
...
<td class="padding1" valign="top">
Adalah menjadi satu syarat pembiayaan ini bahawa tuan/puan memberikan persetujuan kepada pihak ALM CORE SOLUTIONS SDN BHD untuk memasukkan segala maklumat berkenaan pembiayaan tuan/puan kedalam sistem daftar <i>Financial Information Services Sdn Bhd (FIS)</i> dan/atau mana-mana syarikat lain atau agensi yang seumpama dengannya untuk kegunaan semua ahli atau penyumbang kepada syarikat/agensi tersebut.
