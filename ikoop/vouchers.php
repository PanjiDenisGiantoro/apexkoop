...
'<tr>
	<td width="48%">
		<table border="0" cellspacing="1" cellpadding="2">
			<tr>
				<td valign="top">No.</td><td valign="top">:</td><td><input name="no_baucer" type="text" value="'.$no_baucer.'" size="20" maxlength="50" readonly/></td>
			</tr>
		</table>
	</td>
	<td valign="top">&nbsp;</td>
...
<tr>
	<td valign="top">
		<table border="0" cellspacing="1" cellpadding="2">
			<tr><td>No. anggota</td><td valign="top">:</td>
			<td>
