...
if ($by == 1)	print '<option value="1" selected>No Dokumen</option>'; 	else print '<option value="1">No Dokumen</option>';				
if ($by == 3)	print '<option value="3" selected>Urusniaga</option>'; 	else print '<option value="3">Urusniaga</option>';							
print '		</select>
