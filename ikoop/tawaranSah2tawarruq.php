...
for ($i = 1; $i <= count($FormLabel); $i++) {
	...
	if ($i == 1) print '<div class="card-header mb-3 mt-3">i. PENGESAHAN ON-LINE DOKUMEN PEMBIAYAAN TELAH LENGKAP DAN SEMPURNA SERTA PERMOHONAN UNTUK MENGELUARKAN PEMBIAYAAN</td></tr>';
...
<tr><tdcolspan=4 class=Data></td> </tr>
</table></form>';
include("footer.php");	
print '
