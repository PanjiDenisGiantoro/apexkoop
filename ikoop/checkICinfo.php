						...
						.'<tr>'
							...
							.'<table border="0" cellpadding="0" cellspacing="6" width="100%" align="center">'
								.'<tr>'
									...
									.'Maklumat tertera di bawah didapati telah berhenti dalam sistem iKOOP - ALM CORE SOLUTIONS SDN BHD<br>'
									.'Sila rujuk pada pihak ALM CORE SOLUTIONS SDN BHD untuk tindakan susulan.'
									.'</td>'
								.'</tr>'
					...
					.'<tr class="table-light">'
						.'<td class="borderleftrightbottomred">'
							.'<table border="0" cellpadding="0" cellspacing="6" width="100%" align="center">'
								.'<tr>'
									.'<td class="textFont" colspan="3" height="30">'
									.'Maklumat tertera di bawah didapati telah berdaftar dalam sistem iKOOP-ALM CORE SOLUTIONS SDN BHD <br><br>'
									.'*Jika Status Anda "Dalam Proses" (SILA BUAT PEMBAYARAN PENDAFTARAN). Sekiranya Bayaran telah dibuat, ALM CORE SOLUTIONS SDN BHD akan memproses permohonan anda dalam <b>7-8 HARI WAKTU BEKERJA</b>.<br><br>'
									.'Sila rujuk pada pihak ALM CORE SOLUTIONS SDN BHD untuk tindakan susulan atau meminta <b>ID PENGGUNA @ KATA LALUAN </b> (sekiranya masih tiada / terlupa). <br><br>'
									...
									.'</td>'
								.'</tr>'
								.'<tr><td class="textFont">Nama/No. Anggota </td><td>:</td><td class="textFont"><b>'.strtoupper($name).' - ('.$memberID.')</b></td></tr>'
                                                    ...
                                                    $detail .=
                                                                    '<form name="MyForm">'					
                                                                                .'<div class="alert alert-danger alert-dismissible fade show mb-0" role="alert">
                                                                                    ...
                                                                                    <strong>Ralat!</strong> Keanggotaan anda tiada rekod di dalam sistem iKOOP/ALM CORE SOLUTIONS SDN BHD, Sekiranya anda masih menjadi anggota (aktif) Koperasi ALM CORE SOLUTIONS SDN BHD, Sila Hubungi Pihak ALM CORE SOLUTIONS SDN BHD untuk pengesahan atau membuat permohonan baru sebagai anggota, Segala kesulitan amat dikesali. Terima Kasih.
