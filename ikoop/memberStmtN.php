...
$sFileName = '?vw=memberStmt&mn=10'; 
$sFileRef  = '?vw=memberStmt&mn=10';
	...
	Bulan   : 
			...
			<option value="ALL"';
				...
				<tr class="table-success">
					...
					<input type="button" class="but" value="Keseluruhan" onClick="ITRActionButtonClick(\'feesYearlyAll\');" style="width:100px;">            
					</td>
				</tr>
				<tr class="table-success">
				...
				<tr>
					...
					<td class="textFont">:&nbsp;
	    		    <input type="button" class="but" value="Bulanan" onClick="ITRActionButtonClick(\'memberMonthly\');" style="width:100px;">            
	        		<input type="button" class="but" value="Tahunan" onClick="ITRActionButtonClick(\'memberYearly\');" style="width:100px;">            
					</td>
				</tr>
				<tr>
					<td class="textFont">Pembiayaan</td>
					<td class="textFont">:&nbsp; 
			        <!--input type="button" class="but" value="Jadual" onClick="ITRActionButtonClick(\'memberLoan\');" style="width:100px;"--> 
					<input type="button" class="but" value="Tahunan" onClick="ITRActionButtonClick(\'loanUserYearly\');" style="width:100px;">                       
					</td>
				</tr>

				<tr>
					<td class="textFont">Penyata Tahunan Anggota</td>
					<td class="textFont">:&nbsp; 
	   			    <input type="button" class="but" value="Tahunan" onClick="ITRActionButtonClick(\'memberPenyataYearly\');" style="width:100px;">            
					</td>
				</tr>
			</table>
		</td>
...
print '
	<tr>
		<td class="Label" valign="top">
		<i class="mdi mdi-arrow-right"></i>&nbsp;&nbsp;<a href="#" onclick="selectPenyata(\'memberYearly\')">Urusniaga</a>
		</td>
	</tr>
	';
...
print '
	<tr>
		<td class="Label" valign="top">
		<i class="mdi mdi-arrow-right"></i>&nbsp;&nbsp;<a href="#" onclick="selectPenyata(\'memberPenyataYearly\')">Anggota</a>
		</td>
	</tr>';
...
<script language="JavaScript">
	...
	function selectPenyata(rpt) {
		if (rpt == "feesMonthly" || rpt == "shareMonthly" || rpt == "memberMonthly") {
			...
			url = "?vw=selYearN&mn=10&rpt="+rpt+"&id='.$ID.'";
		} else {
			url = "?vw=selYearN&mn=10&rpt="+rpt+"&id='.$ID.'";
		}
