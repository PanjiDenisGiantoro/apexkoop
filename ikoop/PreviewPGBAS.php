...
Where a.userID = b.userID AND a.userID = c.userID AND c.lastyrmthPymt >= '".$yrmthNow."' AND a.status = 1 group by a.userID order by CAST( a.userID AS SIGNED INTEGER )";
...
<table border="0" cellspacing="1" cellpadding="3" width="100%" align="center">
	...
	<input type="button" class="but" value="csv" onClick="ITRActionButtonFinish(\'csv\');">
	</tr>';
...
print '  <tr valign="top" >
			<td valign="top">
				<table border="0" cellspacing="1" cellpadding="2" width="100%" class="lineBG">
						...
						<td nowrap height="20">&nbsp;No Anggota</td>
						<td nowrap>&nbsp;Nama Anggota</td>
						<td nowrap>&nbsp;Jabatan</td>
						<td nowrap>&nbsp;No Account Tabungan</td>
