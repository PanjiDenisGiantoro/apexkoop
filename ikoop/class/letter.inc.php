...
*          Filename		: 	sekata letter
*		   Version 2    : programmer - mizal 
*********************************************************************************/
...
class CLetter {
	...
	function CLetter() {
	 ...
	 $this->strPostcode  = '';
	 $this->strState  	= '';
	 $this->strInitial  = 'Tuan/Puan';
	 $this->strTitle  	= 'En/Cik';
	...
	function SetInitial($genderID, $martialID) {
		if ($genderID == '0') {
	...
	function SetHeadLetter($type) {
	 if ($type == 0) {
	   ...
	   .'<table border="0" cellspacing="0" cellpadding="0" width="100%">'
		.'<tr>'
			.'<td valign="top" width="90"><img src="images/SEKATARAKYAT.gif" border="0"></td>'
			.'<td valign="middle" class="textFont">'
			.'SEKATARAKYAT<br />'
			.'No. 74A Tingkat Satu, Jalan Kampong Attap, Off Jalan Sulaiman,<br />'
			.'50460 Kuala Lumpur<br />'
			.'Tel: 03-22733314 Faks: 03-22741314 <br>Bahagian Insuran: 03-22733609/22735024'
			.'</td>'
		.'</tr>'
	   .'</table>'
	   .'<hr size="1" width="100%">';
	...
	function GetSekataLineupAddress() {
	$tempAddress = 'No. 74A Tingkat Satu, Jalan Kampong Attap, Off Jalan Sulaiman, 50460 Kuala Lumpur';
...
class CLetterLoan extends CLetter{
	...
	$this->strDataLibList[] = number_format($this->totalBalance, 2);
