	...
	<td width="48%" align="right">
		<table border="0" cellspacing="1" cellpadding="2">
			<tr>
				...
				<td valign="top"></td>
				<td><input class="form-control-sm" name="tarikh_resit" value="'.$tarikh_resit.'" type="text" size="20" maxlength="10" /></td>
			</tr>
		</table>
	</td>
</tr>
	...
	print	   
			'<tr>
				...
				<td class="Data" nowrap="nowrap">
					<input name="desc_akaun['.$id.']" type="text" class="form-control-sm" size="35" maxlength="35" value="'.$desc_akaun.'"/>&nbsp;
				</td>				
...
print	   '
			<tr>
				...
				<td class="Data" align="right">
					...
					<input name="kredit2" type="text" size="10" maxlength="10" class="form-control-sm" value="'.$kredit2.'" />&nbsp;
				</td>
