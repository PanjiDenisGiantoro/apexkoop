...
$sqlGet = "SELECT DISTINCT A.* FROM loans A, userdetails B WHERE ( A.userID = B.userID AND ( A.penjaminID1 = '".$pk."' OR A.penjaminID2 = '".$pk."' OR A.penjaminID3 = '".$pk."')) ORDER BY A.applyDate DESC";
	...
	if ($GetLoan->RowCount() <> 0) {  
		...
		print '<table border="0" cellspacing="1" cellpadding="2" width="100%" class="table table-sm table-striped">
					<tr class="table-primary">
						<td nowrap>&nbsp;</td>
						<td nowrap align="left"><b>No. Rujukan/Pembiayaan&nbsp;[Pengesahan]</b></td>
						<td nowrap align="left"><b>No./Nama Anggota</b></td>
						<td nowrap align="center"><b>Kad Pengenalan</b></td>
						<td nowrap align="right"><b>Jumlah Pembiayaan (RM)</b></td>
						<td nowrap align="center"><b>Tarikh Pengesahan</b></td>			
