...
*          Filename		: 	rptD1.php
*		   Description	:	Report Senarai Urusniaga Bulanan
*		   Parameter	:   $yrmth , $id (ALL)
*          Date 		: 	16/12/2003
*          Amended 		: 	06/04/2004 - allow selection by deduction code
*********************************************************************************/
session_start();
...
$title  = 'Senarai Urusniaga Bulanan';
...
<input type="hidden" name="yrmth" value="'.$yrmth.'">
<table border="0" cellpadding="5" cellspacing="0" width="100%">
	...
	<tr bgcolor="#336699" style="font-family: Arial, Helvetica, sans-serif; font-size: 9pt; font-weight: bold;">
		<th colspan="10" height="40"><font color="#FFFFFF">'.$title.' Bagi Bulan/Tahun '.substr($yrmth,4,2).'/'.substr($yrmth,0,4).'
		</th>
	</tr>
	<tr>
