...
if ($HTTP_COOKIE_VARS["selDB"] == ""){
  $DB_dbtype='mysql'; $DB_hostname='localhost'; $DB_username='root'; $DB_password=''; $DB_dbname='ikoop';
  $DB_dbtype1 = 'mysql'; $DB_hostname1 = 'localhost'; $DB_username1 = 'root'; $DB_password1 = ''; $DB_dbname1 = 'kppkkkb'; 
  $DB_dbtype2 = 'mysql'; $DB_hostname2 = 'localhost'; $DB_username2 = 'root'; $DB_password2 = ''; $DB_dbname2 = 'kpktb';  
  $DB_dbtype3 = 'mysql'; $DB_hostname3 = 'localhost'; $DB_username3 = 'root'; $DB_password3 = ''; $DB_dbname3 = 'kosite';
  $DB_dbtype4 = 'mysql'; $DB_hostname4 = 'localhost'; $DB_username4 = 'root'; $DB_password4 = ''; $DB_dbname4 = 'kpfspb'; 
  $DB_dbtype5 = 'mysql'; $DB_hostname5 = 'localhost'; $DB_username5 = 'root'; $DB_password5 = ''; $DB_dbname5 = 'kohidmas'; 
  $DB_dbtype6 = 'mysql'; $DB_hostname6 = 'localhost'; $DB_username6 = 'root'; $DB_password6 = ''; $DB_dbname6 = 'koguna'; 
  $DB_dbtype7 = 'mysql'; $DB_hostname7 = 'localhost'; $DB_username7 = 'root'; $DB_password7 = ''; $DB_dbname7 = 'kojpjk'; 
  $DB_dbtype8 = 'mysql'; $DB_hostname8 = 'localhost'; $DB_username8 = 'root'; $DB_password8 = ''; $DB_dbname8 = 'komppj'; 
  $DB_dbtype9 = 'mysql'; $DB_hostname9 = 'localhost'; $DB_username9 = 'root'; $DB_password9 = ''; $DB_dbname9 = 'kpfp'; 
  $DB_dbtype10 = 'mysql'; $DB_hostname10 = 'localhost'; $DB_username10 = 'root'; $DB_password10 = ''; $DB_dbname10 = 'koopbait'; 
} else {
	$DB_dbtype='mysql'; $DB_hostname='localhost'; $DB_username='root'; $DB_password='';$DB_dbname=$HTTP_COOKIE_VARS["selDB"];
}
...
function carianheader($by, $opt = array(1,2,3), $dept='',$deptList='',$deptVal='')
{
    echo '<div clas="row">Carian Melalui 
        <select name="by" class="form-select-sm">';
                if (in_array(1, $opt)) if ($by == 1)	print '<option value="1" selected>No./ID Koperasi</option>'; else print '<option value="1">No./ID Koperasi</option>';				
                if (in_array(2, $opt)) if ($by == 2)	print '<option value="2" selected>Nama Koperasi</option>'; else print '<option value="2">Nama Koperasi</option>';				
                if (in_array(3, $opt)) if ($by == 3)	print '<option value="3" selected>Jenis</option>'; else print '<option value="3">Jenis</option>';
                if (in_array(4, $opt)) if ($by == 4) print '<option value="4" selected>Peringkat</option>'; else print '<option value="4">Peringkat</option>';
                if (in_array(5, $opt)) if ($by == 5) print '<option value="5" selected>No. Rujukan</option>';	else print '<option value="5">No. Rujukan</option>';
                if (in_array(6, $opt)) if ($by == 6) print '<option value="6" selected>No. Kenderaan</option>'; else print '<option value="6">No. Kenderaan</option>';
                if (in_array(7, $opt)) if ($by == 7) print '<option value="7" selected>Jumlah Hari Tempoh Tamat Insuran</option>'; else print '<option value="7">Jumlah Hari Tempoh Tamat Insuran</option>';
				if (in_array(8, $opt)) if ($by == 8) print '<option value="8" selected>Singkatan Koperasi</option>'; else print '<option value="8">Singkatan Koperasi</option>';
...
{ 
   $ms = '&nbsp;&nbsp;Paparan
                ...
                if ($pg == 5)	$ms=$ms.'<option value="5" selected>5</option>'; else $ms=$ms.'<option value="5">5</option>';				
                if ($pg == 10) $ms=$ms.'<option value="10" selected>10</option>'; else $ms=$ms.'<option value="10">10</option>';				
                if ($pg == 20) $ms=$ms.'<option value="20" selected>20</option>'; else $ms=$ms.'<option value="20">20</option>';				
                if ($pg == 30) $ms=$ms.'<option value="30" selected>30</option>'; else $ms=$ms.'<option value="30">30</option>';				
                if ($pg == 40) $ms=$ms.'<option value="40" selected>40</option>'; else $ms=$ms.'<option value="40">40</option>';				
                if ($pg == 50) $ms=$ms.'<option value="50" selected>50</option>';else $ms=$ms.'<option value="50">50</option>';				
                if ($pg == 100) $ms=$ms.'<option value="100" selected>100</option>';else $ms=$ms.'<option value="100">100</option>';	
                if ($pg == 200) $ms=$ms.'<option value="200" selected>200</option>'; else $ms=$ms.'<option value="200">200</option>';				
                if ($pg == 300) $ms=$ms.'<option value="300" selected>300</option>'; else $ms=$ms.'<option value="300">300</option>';				
                if ($pg == 400) $ms=$ms.'<option value="400" selected>400</option>'; else $ms=$ms.'<option value="400">400</option>';				
                if ($pg == 500) $ms=$ms.'<option value="500" selected>500</option>';else $ms=$ms.'<option value="500">500</option>';				
                if ($pg == 1000) $ms=$ms.'<option value="1000" selected>1000</option>';else $ms=$ms.'<option value="1000">1000</option>';
...
function activityLog($sql, $report, $id, $logid)
{
global $conn;
$report = trim($report);
$sqlTemp = trim($sql);
...
if ($userID == '') $userID = 0;
$sqlAct = 
	"INSERT INTO activitylog (`report`, `sqlType`, `sql`, `byID`, `activityDate`, `activityBy`)".
	" VALUES (".tosql($report, "Text").", ".tosql($type, "Text").",'".$sql."', ".tosql($id, "Text").",".tosql($updatedDate, "Text").", ".tosql($logid, "Text").")";
//print $sqlAct;
...
if($Bulan == 2 ) { $BulanDisp = "Februari"; }
if($Bulan == 3 ) { $BulanDisp = "Mac"; }
if($Bulan == 4 ) { $BulanDisp = "April"; }
if($Bulan == 5 ) { $BulanDisp = "Mei"; }
if($Bulan == 6 ) { $BulanDisp = "Jun"; }
if($Bulan == 7 ) { $BulanDisp = "Julai"; }
if($Bulan == 8 ) { $BulanDisp = "Ogos"; }
if($Bulan == 9 ) { $BulanDisp = "September"; }
if($Bulan == 10 ) { $BulanDisp = "Oktober"; }
if($Bulan == 11 ) { $BulanDisp = "November"; }
if($Bulan == 12 ) { $BulanDisp = "Disember"; }
return $BulanDisp;
}
...
$basicList	= array('Kod Negara', //A
					...
					//'Kod Komoditi',
					'Kod Bank Koperasi'); //Z
$basicVal	= array('A','B','C','E','F','G','H','I','J'/* ,'K','M','N','P','Q','X' */,'Z');

$basicListACC	= array('Kod Klasifikasi',
            'Kod Carta Akaun',
            'Kod Pemiutang',
						'Kod Penghutang',
						'Kod Kumpulan',
...
$basicValACC	= array('AJ','AA','AB','AC','AE','AF','AG','AH','AI');

// Storing Status Tugasan Information
$tugasanList    =   array('Semua', 'Dalam Proses', 'Selesai', 'Ditolak');
$tugasanVal =   array('0', '1', '2', '3');

// Storing group information
$groupList	= array('Anggota','Staf','Pengurus');
$groupVal	= array('0','1','2');

// Storing staf group information
$groupAList	= array('Staf','Pengurus','Penyelia','Pengurus Kewangan','IKMa');
$groupAVal	= array('1','2','3','4', '5');

// Storing surat/email information
$suratList	= array('Notis Pemberitahuan Sistem',
					'Permohonan Menjadi Koperasi',
					'Permohonan Berhenti Koperasi',
					'Permohonan Pembiayaan Koperasi',
...
$senaraiList	= array('Permohonan Anggota',
...
$statusList	=	array('Dalam Proses','SST Diterima','Ditolak','Berhenti','Dibatalkan','Dalam Pemerhatian');
$statusVal	=	array('0','1','2','3','4','5');

// Storing Status FPX Information
$fpxList	=	array('Dalam Proses','FPX Diterima','Ditolak');
$fpxVal	=	array('0','1','2');

// Storing Berhenti Status Information
$berhentiList	=	array('Dalam Proses','Diluluskan','Ditolak','Berhenti','Dibatalkan');
$berhentiVal	=	array('0','1','2','3','4');

// Storing Jenis Information
$jenisList	=	array('Kredit','Bukan Kredit');
$jenisVal	=	array('0','1');

// Storing StatusMigrasi Information
$migrasiList	=	array('Tidak Diberi','Diberi');
$igrasiVal	=	array('0','1');
...
//Storing training status
$trainingList = array('Belum dilatih', 'Terlatih');
$trainingVal = array('0', '1');

//$fasaList = array('Tiada Fasa','Fasa 1', 'Fasa 2', 'Fasa 3');
//$fasaVal = array('0','1','2','3');

// Storing surat/email information
$lapList	= array('Laporan Koperasi',
					'Laporan Pembiayaan',
					'Laporan Surat/Emel',
					'Laporan Akaun');
...
if ($_COOKIE["selDB"] == ""){
  ...
  //  $DB_dbtype1 = 'mysql'; $DB_hostname1 = 'localhost'; $DB_username1 = 'root'; $DB_password1 = ''; $DB_dbname1 = 'kppkkkb';
   $DB_dbtype2 = 'mysql'; $DB_hostname2 = 'localhost'; $DB_username2 = 'root'; $DB_password2 = ''; $DB_dbname2 = 'kpktb'; 
  //  $DB_dbtype3 = 'mysql'; $DB_hostname3 = 'localhost'; $DB_username3 = 'root'; $DB_password3 = ''; $DB_dbname3 = 'kakib';  
  // $DB_dbtype4 = 'mysql'; $DB_hostname4 = 'localhost'; $DB_username4 = 'root'; $DB_password4 = ''; $DB_dbname4 = 'kpfspb';  
  $DB_dbtype5 = 'mysql'; $DB_hostname5 = 'localhost'; $DB_username5 = 'root'; $DB_password5 = ''; $DB_dbname5 = 'kohidmas'; 
  $DB_dbtype6 = 'mysql'; $DB_hostname6 = 'localhost'; $DB_username6 = 'root'; $DB_password6 = ''; $DB_dbname6 = 'koguna'; 
  // $DB_dbtype7 = 'mysql'; $DB_hostname7 = 'localhost'; $DB_username7 = 'root'; $DB_password7 = ''; $DB_dbname7 = 'kobakti'; 
  $DB_dbtype8 = 'mysql'; $DB_hostname8 = 'localhost'; $DB_username8 = 'root'; $DB_password8 = ''; $DB_dbname8 = 'cobe'; 
  $DB_dbtype9 = 'mysql'; $DB_hostname9 = 'localhost'; $DB_username9 = 'root'; $DB_password9 = ''; $DB_dbname9 = 'kpfp'; 
  $DB_dbtype10 = 'mysql'; $DB_hostname10 = 'localhost'; $DB_username10 = 'root'; $DB_password10 = ''; $DB_dbname10 = 'koopbait'; 
  $DB_dbtype11 = 'mysql'; $DB_hostname11 = 'localhost'; $DB_username11 = 'root'; $DB_password11 = ''; $DB_dbname11 = 'sekata';  
} else {
  $DB_dbtype='mysql'; $DB_hostname='localhost'; $DB_username='root'; $DB_password='';$DB_dbname=$_COOKIE["selDB"];
}
