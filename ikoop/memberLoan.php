...
<table border="0" cellspacing="1" cellpadding="3" width="100%" align="center">
	...
	<tr>
		<td>
			<table width="100%">
				<tr>
					<td class="textFont" width="150">No. Anggota</td>
	...
	if ($GetLoan->RowCount() <> 0) {  
			...
			<td valign="top">
				<table border="0" cellspacing="1" cellpadding="2" width="100%" class="lineBG">
					<tr class="header">
						...
						<td nowrap align="center">&nbsp;Jadual Pembayaran Balik</td>
		...
		while (!$GetLoan->EOF && $cnt <= $pg) {
			...
			print ' <tr>
						...
						<td class="Data">&nbsp;'.dlookup("general", "name", "ID=" . tosql($GetLoan->fields(loanType), "Number")).'</td>
...
print '
	...
	<table width="100%">
		<tr>
			<td class="textFont" width="150">No. Rujukan ID</td>
