...
if ($SubmitForm <> "") {
	...
	if ($memberID <> "") {
		if (dlookup("userdetails", "userID", "memberID=" . tosql($memberID, "Text")) == "") {
			...
			print '- <font class=redText>No Anggota - '.$memberID.' tidak wujud...!</font><br>';
			$userName = "";
			$newIC = "";
			$oldIC = "";
			$unitOnHand = "";
...
<tr>
<td class="borderallblue" align="left" valign="middle"><div class="headerblue"><b>BORANG PERMOHONAN BERHENTI/BERSARA DARI PERKHIDMATAN</b></div></td>
</tr>
<tr>
