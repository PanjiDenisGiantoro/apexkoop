...
*          Filename		: 	rptA19.php
*		   Description	:	Report Senarai Koperasi Ada Maklumat Bank
*          Date 		: 	12/12/2021
*********************************************************************************/
session_start();
...
$title  = 'Senarai Koperasi Ada Maklumat Bank';
...
$sSQL = "";
$sSQL = "SELECT	a.name,CAST(b.kopNum AS SIGNED INTEGER) as kopNum, b.approvedDate,b.jenis,b.accTabungan,b.bankID,c.name as department
					...
					if ($rs->fields(accTabungan)=='') $rs->MoveNext();
						if ($tempDept <> $rs->fields(department)) {
							...
							<tr bgcolor="#C0C0C0" style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt; font-weight: bold;">
								<th nowrap>&nbsp;</th>
								<th nowrap width="100" align="center">&nbsp;No./ID Koperasi</th>
								<th nowrap align="left">&nbsp;Nama Koperasi</th>
								<th nowrap width="150" align="center">&nbsp;Jenis</th>
								<th nowrap width="200" align="center">&nbsp;Nombor Akaun Bank</th>
								<th nowrap width="200" align="center">&nbsp;Nama Bank</th>
						...
						<tr style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt;" bgcolor="FFFFFF">
							...
							<td align="center">&nbsp;'.$rs->fields(accTabungan).'</a></td>
							<td align="center">&nbsp;'.$namabank.'</a></td>
