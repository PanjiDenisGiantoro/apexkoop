...
if ($loanAmt > 100000){	$houseOn = "YA"; }else{ 	$houseON = "TIDAK";}
	...
	<tr>
		...
		<td colspan="17">
			<table border=0  cellpadding="2" cellspacing="1" align=left width="100%" class="table table-sm table-striped">
				<tr style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt; font-weight: bold;" class="table-secondary">
					<th nowrap>Nama</th>
...
print '		
	...
	<tr style="font-family: Arial, Helvetica, sans-serif; font-size: 9pt; font-weight: bold;" class="table table-sm table-striped">
	<tr class="table-primary">
				...
				<!--tr bgcolor="#C0C0C0" style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt; font-weight: bold;">
					...
					<th nowrap>Nisbah DSR(%)</th>
						...
						<tr style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt;" bgcolor="FFFFFF">
							...
							<td>&nbsp;'.number_format($hadPeratus,2).'</td>
                                                ...
                                                print '<tr class="table-secondary" style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt; font-weight: bold;">
					<th nowrap>SEWA</th>
					<th nowrap>Lain-Lain</th>
					<th nowrap>Dividen</th>
					<th nowrap>Jum Gaji Kasar</th>
					...
					<th nowrap>SOCSO</th>
							...
							<td>'.$SOCSO.'</td>
                                                ...
                                                <tr class="table-secondary" style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt; font-weight: bold;">
                                                                                        <th nowrap>Jum. EPF&SOCSO</th>
					<th nowrap>CCRIS Dan PAT</th>
					<th nowrap>POT.(STATUTORI)</th>
					<th nowrap>Jum. Potongan Baru</th>
