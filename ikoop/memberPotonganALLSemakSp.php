...
$sFileName = 'memberPotonganALLSemakSp.php'; 
$sFileRef  = 'Edit_memberStmtPotongan.php';
$title     = "Senarai Potongan Gaji (PGB) Pembiayaan / Yuran Dan SPSN";
...
Where a.userID = b.userID AND a.userID = c.userID AND c.yrmth <= '".$yrmth."' AND c.lastyrmthPymt >= '".$yrmthNow."' AND a.status = 1 group by a.userID order by CAST( a.userID AS SIGNED INTEGER )";
