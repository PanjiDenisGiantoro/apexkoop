...
$sSQL = "	SELECT a.departmentID, b.code as deptCode, b.name as deptName 
			...
			AND   a.status IN (1) AND a.departmentID NOT IN (1598,1600,1599,1584,1706,1841,1770)
...
//$GetMember = ctMemberStatusDept($q,$by,"1",$dept);
	$sSQL = "";
	$sWhere = " a.userID = b.userID AND a.userID = c.userID  AND b.status IN (1,4) AND c.status = 2 and c.yrmth < '".$yrmthNow."' AND c.lastyrmthPymt >= '".$yrmthNow."'";
	if ($dept <> "") 	{
