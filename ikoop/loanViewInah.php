...
$sFileName = 'loanViewInah.php';
$sFileRef  = 'loanViewInah.php';
...
print $chk.'&nbsp;&nbsp;<input type=button value="Pengesahan" class="but" onClick=window.open("tawaranSah.php?ID='.$GetLoan->fields(loanID).'","pop","top=50,left=50,width=1700,height=450,scrollbars=yes,resizable=yes,toolbars=no,location=no,menubar=no");>';
}
	
if ($prove == 1 & $status == 3) {print $chk. '&nbsp;&nbsp;<input type=button value="Surat Tawaran" class="but" onClick=window.open("tawaranSah2.php?ID='.$GetLoan->fields(loanID).'","pop","top=50,left=50,width=700,height=450,scrollbars=yes,resizable=yes,toolbars=no,location=no,menubar=no");>';}
