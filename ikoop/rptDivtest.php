...
$title  = 'Ringkasan Keseluruhan Dividen Anggota Mengikut Pegangan Yuran Pada Tahun '.$yr ;

	$sSQL = "";
	$sWhere = " a.userID = b.userID AND a.userID = c.userID AND c.AmtDiv > 0 and c.yearDiv = '".$yr."' and b.status IN (1,4)";;
	if ($dept <> "") 	{
		...
		<td>
			<table border=0  cellpadding="2" cellspacing="1" align=left width="100%">
				<tr bgcolor="#C0C0C0" style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt; font-weight: bold;">
					...
					<th width="40" align="left" nowrap><div align="right">No Anggota </th>
...
//$bakiAkhir = 0;
	...
	$totalUpfrontD += $totalUpfront ;
					...
					print '
					<tr bgcolor="FFFFFF"><td colspan="10"><hr size=1></td></tr>						
					<tr style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt;" bgcolor="FFFFFF">
