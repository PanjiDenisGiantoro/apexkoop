...
*          Filename		: 	rptF1.php
*		   Description	:	Report Ringkasan Keseluruhan Koperasi
*          Date 		: 	05/04/2004
*********************************************************************************/
session_start();
include("common.php");	
...
$title  = 'Ringkasan Keseluruhan Koperasi Mengikut Zon';
		...
		<td>
			<table border=0  cellpadding="2" cellspacing="1" align=left width="100%">
				<tr bgcolor="#C0C0C0" style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt; font-weight: bold;">
					...
					<td nowrap align="center" width="200">Jumlah Koperasi</td>
				</tr>';
				$total = 0;
				if ($rs->RowCount() <> 0) {	
					while(!$rs->EOF) {	
...
*/					//------------------------------------------------------------
				...
				print '
					...
					<tr style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt;" bgcolor="FFFFFF">
						<td colspan="2" align="right">Jumlah Keseluruhan Koperasi :</td>
