...
$title  = 'Senarai bagi anggota MSS';
				...
				if ($rs->RowCount() <> 0) {	
					while(!$rs->EOF) {	
						if ($bil == 0) {
							...
							} //'.$rs->fields(department).'							<tr><td colspan="7"  style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt; font-weight: bold;" height="30" valign="bottom">	Bersara </td></tr>
							print '
							...
							<tr bgcolor="#C0C0C0" style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt; font-weight: bold;">
								...
								<th nowrap width="80">&nbsp;No. KP Baru</th>
