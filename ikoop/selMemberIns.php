...
<script language="JavaScript">
	function selAnggota(userid,memberid,name,newic,email)
	{	
...
if ($GetMember->RowCount() == 0) {
	...
	if ($GetMember->RowCount() <> 0) {  
		...
		print '	<tr>
			...
			<td align="center"><b>No. Anggota</b></td>
...
<td class="Data" align="center"><a href="javascript:selAnggota(\''.$userid.'\',\''.$memberid.'\',\''.$name.'\',\''.$newic.'\',\''.$email.'\');">'.$memberid.'</a></td>
<td class="Data"><a href="javascript:selAnggota(\''.$userid.'\',\''.$memberid.'\',\''.$name.'\',\''.$newic.'\',\''.$email.'\');">'.$name.'</a></td>
