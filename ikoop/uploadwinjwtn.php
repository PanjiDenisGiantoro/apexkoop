...
print '<h4 class="card-title"><i class="fas fa-upload"></i>&nbsp;' . strtoupper($title) . '</h4>
            ...
            <table class="table mb-3">
                    <tr class="table-primary">
                        <td class=Header><h6 class="card-subtitle">Sila Masukkan Slip Pengesahan Jawatan Anda: '.$no_resit.'</h6></td>
                    </tr>
                
                    <tr class="table-light">
                        <td class="Data">
                                    
                                    <form action="?vw=uploadwinjwtn&mn=3&action=upload" method=post  enctype="multipart/form-data">
