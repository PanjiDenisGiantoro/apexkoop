...
<body data-topbar="colored">
    ...
    <div id="layout-wrapper">
            ...
            <div class="navbar-header">
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        <a class="dropdown-item text-white" href="?vw=logout" onclick="return confirm('Are you sure?')" style="background-color:#549b04;">
        ...
        <!-- ========== Left Sidebar Start ========== -->
        <div class="vertical-menu" style="background-color: #ff5d65;" >
        <!-- #2b3a4a -->
