...
$title  = 'Penyata Penyemakan Bank Rekonsilasi Dari '.$dtFrom.' Hingga '.$dtTo.'';

$sSQL = "SELECT * FROM transactionacc WHERE stat_check IN (0) AND (tarikh_doc BETWEEN '".$dtFrom."' AND '".$dtTo."') ORDER BY tarikh_doc ASC ";
