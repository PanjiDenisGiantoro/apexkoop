		...
		<td colspan="5">
			<table border=0  cellpadding="2" cellspacing="1" align=left width="100%" bgcolor="999999">
				<tr bgcolor="#C0C0C0" style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt; font-weight: bold;">
					...
					<th nowrap rowspan=2>&nbsp;No./ID Koperasi</th>
					<th nowrap rowspan=2>&nbsp;Zon</th>
				...
				if ($rs->RowCount() <> 0) {	
					while(!$rs->EOF) {	
						...
						$kopNum = dlookup("userdetails", "kopNum", "userID=" . tosql($rs->fields(userID), "Number"));
