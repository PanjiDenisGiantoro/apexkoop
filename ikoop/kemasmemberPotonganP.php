...
$title     = "Kemaskini Potongan Gaji (PGB) Pembiayaan (NAIK SEKOLAH, UMRAH, INSURANS)";
...
$sSQLUpd = "UPDATE potbulanlook SET "." pokokE= '".$FeePokok."'".",untungE='".$pymtUntg."'"." ,status= 2"." WHERE ID= '".$IDtype."'";
...
$sSQL = "	SELECT DISTINCT c.loanType, b.code as deptCode, b.name as deptName 
			...
			WHERE b.ID = c.loanType AND c.loanType IN (1540,1620,1616,1630) AND c.status = 1";
			...
			<td>
				<table width="100%">
					<tr>
						...
						<input type="button" class="but" value="Preview PGB" onclick="window.open(\'PreviewcsvPGBP.php?dept='.$dept.'&yy='.$yy.'&mm='.$mm.'\')">
