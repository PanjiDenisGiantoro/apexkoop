	...
	<tr>
		<td class="Data">
			<table border="0" cellspacing="1" cellpadding="3" width="100%" align="center">
				<tr>
					<td	class="Header" colspan="2">Klik pada Jabatan dan klik pada No. Anggota Atau Nama untuk pilihan.</b></td>
				</tr>';
$totalUser = 0;
if ($GetDept->RowCount() <> 0) {  
	...
	while (!$GetDept->EOF) {
		...
		if ($GetUserDept->RowCount() <> 0) { 
			...
			<table border="0" cellpadding="2" cellspacing="1" width="500" class="Data">
				<tr>
					<td class="header">&nbsp;No. Anggota</td><td class="header">&nbsp;Nama</td>
				</tr>';
	...
	print '
				<tr><td	class="Label" align="center">
					<hr size="1"><b>- Tiada rekod mengenai Zon -</b><hr size="1">
				</td></tr>';
}
print '		</table>
		</td>
