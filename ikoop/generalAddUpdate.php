...
if ($action == "simpan") print '<h6 class="card-subtitle">Kemasukan '.$title; else print '<h6 class="card-subtitle">Kemaskini '.$title.' : '.tohtml($rs->fields(name));
print '</h6></td></tr>';
...
if ($action == "tambah") {
	...
	if(get_session("Cookie_groupID") == '2'){
		print'<input type=Submit name=SubmitForm class="btn btn-primary btn-md waves-effect waves-light" value="Kemaskini">';
	}
	}
}
print '		</td>
