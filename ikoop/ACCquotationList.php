...
print '&nbsp;&nbsp;
	...
	<input type="button" name="add" class="btn btn-sm btn-primary" value="Tambah" onClick="location.href=\'' . $sFileRef . '&action=new&jenis=' . $jenis . '\';">';
