...
*          Filename		: 	KemasmemberPotongan.php
*          Date 		: 	15/6/2006
*********************************************************************************/
...
$sFileName = 'KemasmemberPotongan.php'; 
$sFileRef  = 'Edit_memberStmtPotongan.php';
$title     = "Kemaskini Potongan Gaji (PGB) Pembiayaan";
...
$yymmTT = $yyT.$mmT2;
	...
	$sSQL = "";
	$sWhere = " a.loanID = b.loanID  AND a.status = 1 AND b.yrmth between '".$yymmTT."'  and '".$yymm."'  AND b.loanType NOT IN (1616,1540,1620,1630) And a.userID = c.userID";
	if ($dept <> "") 	{
