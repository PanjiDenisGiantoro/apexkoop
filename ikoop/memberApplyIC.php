...
$a++;
$FormLabel[$a]   	= "* No. Telefon Koperasi<br><b>(603XXXXXXXX)</b>";
...
$a++;
$FormLabel[$a]   	= "No Anggota Pencadang (1)";
...
$a++;
$FormLabel[$a]   	= "No Anggota Pencadang (2)";
...
$a++;
$FormLabel[$a]   	= "* No. Akaun Bank<br><b>(XXXXXXXXXXXXXXXX)</b>";
	...
	if ($accTabungan) {
		if(!dlookup("userdetails", "newIC", "newIC=" . tosql($newIC, "Text")) ) {
			if(dlookup("userdetails", "accTabungan", "accTabungan=" . tosql($accTabungan, "Text")) <> '') {
				...
				print '- <font class=redText>* No. akaun tersebut telah digunakan.</font><br />';
			}
		}
	}
...
?>
<tr><td colspan="4" align=center class=Data>
