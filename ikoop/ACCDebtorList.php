...
if ($by == 2)	print '<option value="2" selected>No. RV</option>';
else print '<option value="2">No. RV</option>';
if ($by == 3)	print '<option value="3" selected>No. Invois</option>';
			...
			<td valign="top">
				<table border="0" cellspacing="1" cellpadding="2" width="100%" class="table table-sm table-striped">
					<tr class="table-primary">
						...
						<td nowrap style="text-align: left; vertical-align: bottom;"><b>No. Bayaran</b></td>
						...
						<td nowrap><div style="text-align: center; white-space: nowrap;"><b>No. Invois/</b><br><b>Opening Balance</b></div></td>
						<td nowrap><div style="text-align: right; white-space: nowrap;"><b>Amaun Invois/</b><br><b>Tunggakan (RM)</b></div></td>
