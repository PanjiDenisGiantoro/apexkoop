...
*          Filename		: 	rptA20.php
*		   Description	:	Report Senarai Koperasi Tiada Maklumat Bank
*          Date 		: 	12/12/2021
*********************************************************************************/
session_start();
...
$title  = 'Senarai Koperasi Tiada Maklumat Bank';
...
$sSQL = "";
$sSQL = "SELECT	a.name,CAST(b.kopNum AS SIGNED INTEGER) as kopNum, b.approvedDate, b.jenis, c.name as department  
		 FROM 	users a, userdetails b
		 INNER JOIN general c
		 ON		c.ID = b.departmentID 
		 WHERE  a.userID = b.userID 
		 AND 	b.status = '1' 
		 AND    (BIT_LENGTH(trim(b.accTabungan)) = 0 OR b.accTabungan IS NULL)"; 
if ($dept <> "ALL")
