...
<tr>
	<td width="48%">
		<table border="0" cellspacing="1" cellpadding="2">
			<tr>
				<td valign="top">No.</td><td valign="top">:</td><td><input name="" type="text" size="20" maxlength="50" /></td>
			</tr>
		</table>
	</td>
	<td valign="top">&nbsp;</td>
	<td width="48%" align="right">
		<table border="0" cellspacing="1" cellpadding="2">
			<tr>
				<td valign="top" align="right">Tarikh</td><td valign="top">:</td><td><input name="" type="text" size="20" maxlength="10" /></td>
			</tr>
		</table>
	</td>
</tr>
...
<tr>
	<td valign="top">
		<table border="0" cellspacing="1" cellpadding="2">
			<tr><td>Kod</td><td valign="top">:</td>
			<td>
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td><input name="" type="text" size="20" maxlength="50" /></td>
					<td><input type="checkbox" class="form-check-input" /></td><td>Tunai</td>
					<td><input type="checkbox" class="form-check-input" /></td><td>Tunai Runcit</td>
				</tr>
			</table>
			</td></tr>
			<tr><td>Nama</td><td valign="top">:</td><td><input name="" type="text" size="50" maxlength="10" /></td></tr>
		</table>
	</td>
	<td valign="top">&nbsp;</td>
	<td width="48%" align="right" valign="top">
		<table border="0" cellspacing="1" cellpadding="2">
			...
			<tr>
				<td valign="top" align="right">No. Rujukan</td><td valign="top">:</td>
				<td><input name="" type="text" size="20" maxlength="10" /></td>
			</tr>
			<tr>
...
<tr>
	<td width="60%" valign="top" colspan="3">
		<table border="0" cellspacing="1" cellpadding="3">
			<tr><td colspan="3" nowrap="nowrap">Jumlah Dalam Perkataan<br /><input name="" size="80" maxlength="80"></td></tr>
			<tr><td nowrap="nowrap">Kerani Kewangan</td><td valign="top">:</td><td><select><option>NOREHA BINTI MIZI</option></select></td></tr>
			<tr><td nowrap="nowrap" valign="top">Catatan</td><td valign="top">:</td><td valign="top"><textarea cols="50" rows="4">BAYARAN SUMBANGAN KOMISEN INSURAN BAGI TAHUN 2006</textarea></td></tr>
		</table>
	</td>
</tr>
<?
