...
if ($action == "Jana Laporan") {
	...
	if ($msg <> "") {
		...
		<script>
			var rptURL;
			rptURL = "?vw='.$rpt.'&mn=10&yr='.$yr.'&pk='.$id.'&id='.$id.'";
...
<form name="FrmSelection" action="" method="post">
	...
	<table cellpadding="3" cellspacing="0" class="table table-striped" style="padding: 1 0 0 0" >
		...
		<tr class="table-light">
			...
			<input type="button" class="btn btn-secondary w-sm waves-effect waves-light" value="<<" onClick="window.location.href=\'?vw=memberStmtN&mn=10\';">
